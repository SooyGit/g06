        ...
        >
            <div>
                ...
                <div className="text-center my-0.5">
                    ...
                    <div className="text-[10px] text-gray-500 mt-0">信用点/建筑/次 (基{base.toFixed(2)})</div>
                </div>
            </div>
                    ...
                    {activeTaxTab === 'head' && (
                        <div className="space-y-3">
                            <div className="bg-blue-900/20 border border-blue-500/30 p-2 rounded-lg text-[11px] text-blue-100">
                                ...
                                <p>对各阶层幸存者征收的税收。税率系数越高，税收越多，但可能影响阶层满意度。</p>
                            </div>
...
<div className="glass-ancient p-4 rounded-lg border border-ancient-gold/30 text-center">
                        ...
                        <h3 className="text-lg font-bold text-gray-400 mb-2">管理者系统未解锁</h3>
                        <p className="text-gray-500 text-sm">
                            进入<span className="text-orange-400 font-semibold">废墟拾荒</span>后，方可启用管理者制度。
                        </p>
                    </div>
                )
            )}
