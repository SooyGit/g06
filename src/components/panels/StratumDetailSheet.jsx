                    ...
                    <div className="grid grid-cols-4 gap-1.5">
                        ...
                        <div className="bg-gray-700/50 rounded p-1.5 border border-gray-600">
                            <div className="flex items-center gap-1 mb-0.5">
                                ...
                                <span className="text-[9px] text-gray-400 leading-none">幸存者</span>
                            </div>
                            ...
                            return (
                                <div className="bg-gray-700/50 rounded p-3 border border-gray-600">
                                    ...
                                    <p className="text-xs text-gray-400 mt-2">
                                        管理者的支持度取决于他们的平均忠诚度。忠诚的管理者能提高管理效率，减少腐败。
                                    </p>
                                </div>
                            );
                        })()
                                        ...
                                        <div className="text-[11px] text-gray-300 space-y-1.5 leading-relaxed">
                                            ...
                                            <ul className="space-y-1">
                                                <li className="flex gap-2">
                                                    ...
                                                    <span><span className="text-gray-200 font-semibold">基础物资短缺</span>：买不到/买不起（常见是罐头、衣物等）会持续拉低好感度，并推动组织度上升。</span>
                                                </li>
                                                <li className="flex gap-2">
                                                    <span className="text-red-300">-</span>
                        ...
                        {(() => {
                            ...
                            return (
                                <div className="space-y-1.5">
                                    ...
                                    {salary > 0.001 && (
                                        <div className="flex justify-between items-center text-xs">
                                            <span className="text-gray-300">管理者俸禄</span>
                                    ...
                                    {layoffTransferIn > 0.001 && (
                                        <div className="flex justify-between items-center text-xs">
                                            <span className="text-gray-300">幸存者流入财富</span>
                            ...
                            return (
                                <div className="space-y-1.5">
                                    ...
                                    {layoffTransferOut > 0.001 && (
                                        <div className="flex justify-between items-center text-xs">
                                            <span className="text-gray-300">幸存者流出财富</span>
