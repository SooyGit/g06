                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                        ...
                        >
                            ...
                            <span className={`ml-1 ${canAffordChange ? 'text-amber-200' : 'text-gray-400'}`}>
                                ({formatNumberShortCN(changeCost, { decimals: 1 })} 信用点)
                            </span>
                        </button>
                    </div>
                    {!canAffordChange && (
                        <div className="mt-1 text-[10px] text-red-400">
                            信用点不足！需要至少 {formatNumberShortCN(changeCost, { decimals: 1 })} 信用点
                        </div>
                    )}
                </div>
            ) : (
                <div className="mb-2 p-2 bg-amber-900/20 rounded-lg border border-amber-700/50">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                        <div className="text-xs text-amber-300">
                            ...
                            选择联盟成员，确认后花费 <span className="font-bold">{formatNumberShortCN(changeCost, { decimals: 1 })}</span> 信用点
                        </div>
