...
const STRATUM_CONFIG = {
    capitalist: { name: '军阀', color: 'text-purple-400', bg: 'bg-purple-900/30' },
    merchant: { name: '商贩', color: 'text-amber-400', bg: 'bg-amber-900/30' },
    landowner: { name: '区长', color: 'text-green-400', bg: 'bg-green-900/30' },
};
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="text-[10px] text-gray-500 bg-gray-900/30 border border-gray-800/40 rounded-lg p-2">
                外资利润税会在每日结算时自动扣除并计入物资库（税率受条约/共同体等外联规则影响）。
            </div>
