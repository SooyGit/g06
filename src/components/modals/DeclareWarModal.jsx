 ...
 * @param {Array} militaryOrgs - 目标国家的战斗组织列表，每个组织包含name和members数组
                        ...
                        {hasAllies && (
                            <div className="p-3 bg-orange-900/30 rounded-lg border border-orange-500/40">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <span className="text-sm font-bold text-orange-200">战斗组织警告</span>
                                </div>
                                <p className="text-[11px] text-orange-100 mb-3 leading-relaxed">
                                    {targetNation.name} 拥有 <span className="font-bold text-orange-300">{militaryOrgs.length}</span> 个战斗组织盟友。
                                    向其宣战将同时与这些国家进入战争状态！
                                </p>
                            ...
                            <div className="p-3 bg-gray-800/40 rounded-lg border border-gray-600/30">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-xs text-gray-300">
                                        {targetNation.name} 当前没有战斗组织盟友，只需对抗一个敌人。
                                    </span>
                                </div>
                            </div>
                        )}
