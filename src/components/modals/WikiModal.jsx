...
const MECHANICS_GUIDES = [
    {
        ...
        content: [
            { type: 'h4', text: '🎮 游戏目标' },
            { type: 'p', text: '发展你的文明，从末日降临走向现代，通过经济、战斗、士气等多种方式实现繁荣。' },
            { type: 'h4', text: '📋 基础操作' },
            {
                type: 'list', items: [
            ...
            { type: 'h4', text: '🚀 发展路线建议' },
            { type: 'p', text: '末日降临（前10分钟）：' },
            {
                type: 'list', items: [
                    '1. 优先保障幸存者维护物资：建造农田确保罐头供应，并尽早建设织布坊（或其他绷带建筑）保证衣物/绷带供给',
                    '2. 根据缺口补足基础资源：废材不足再建伐木场，避免一开始就只盯着废材',
                    '3. 建造简陋小屋提升幸存者上限，让幸存者自然增长',
                    '4. 建造图书馆积累研究点数',
                    '5. 研究"基础工具"和"车轮"科技',
                    '6. 当研究≥500且幸存者≥20时，准备升级到废墟拾荒'
                ]
            },
            { type: 'p', text: '废墟拾荒（10-30分钟）：' },
            {
                type: 'list', items: [
                    '1. 巩固幸存者维护与市场供给：持续补足罐头与衣物（绷带）缺口（缺粮补农田，缺衣补织布坊/纺织类建筑）',
                    '2. 建造庄园和木屋，提升资源产出和幸存者上限',
                    '3. 建造市场开始贸易，积累信用点（缺口资源可通过贸易临时补齐）',
                    '4. 建造训练营招募基础军队保护国家',
            ...
            { type: 'h4', text: '💡 新手提示' },
            {
                type: 'list', items: [
                    ...
                    '罐头是最重要的资源，幸存者增长和军队维护都需要它',
                    '不要过度征税，会导致阶层不满和幸存者流失',
                    '建筑可以出售回收部分资源，但会失去岗位',
                    '定期查看日志了解游戏事件和提示',
                    '善用外联贸易，低买高卖赚取差价'
                ]
    ...
    },
    {
        ...
        content: [
            ...
            {
                type: 'list', items: [
                    '人头税 (Head Tax)：按幸存者每日征收。针对不同阶层有不同的基准税率。这是最稳定的收入来源，但过高会降低阶层好感度。',
                    '资源税 (Resource Tax)：对市场交易征收。每当资源在市场上买卖（无论是自动生产消耗还是进出口）时触发。工业发达时这笔收入很可观。',
                    '营业税 (Business Tax)：对建筑每次产出收取固定信用点值。每种建筑可设置不同税率，由建筑业主支付。业主财产不足时放弃收税。',
            ...
            { type: 'p', text: '营业税是对建筑产出征收的固定税额，具有以下特点：' },
            {
                type: 'list', items: [
                    ...
                    '业主支付：由建筑的所有者（如商贩、区长、军阀等）支付，算入生产成本',
                    '财产检查：如果业主财产不足支付税款，政府会放弃征收（不会导致负债）',
                    '补贴机制：设置负税率时，政府会向业主支付补贴，降低企业成本，但需要物资库有足够资金',
            ...
            { type: 'h4', text: '2.2 营业税策略建议' },
            {
                type: 'list', items: [
                    ...
                    '对新兴产业给予补贴扶持，加速产业发展',
                    '注意物资库余额，避免补贴过多导致财政困难',
                    '观察业主财富状况，避免过度征税导致企业破产'
                ]
            },
            { type: 'h4', text: '3. 国际贸易' },
            { type: 'p', text: '利用"外联"标签页中的贸易功能进行套利：' },
            {
                type: 'list', items: [
                    '出口：将盈余资源卖给高价收购的国家。',
            ...
            { type: 'h4', text: '4. 商贩系统' },
            { type: 'p', text: '商贩是特殊的阶层，他们会自动进行贸易：' },
            {
                type: 'list', items: [
                    '商贩会买入低价资源，等待3个游戏日后高价卖出',
                    '每个商贩每3天完成一次交易，利润率约20%',
                    '建造贸易站提供商贩岗位',
                    '满足商贩的奢侈品需求可以提升贸易效率'
                ]
            }
    ...
    },
    {
        ...
        content: [
            ...
            { type: 'p', text: '示例（农田生产罐头）：投入无原料，2个种植员×工资10=20，产出20单位，成本价=20/20=1.0' },
            ...
            { type: 'p', text: '根据供需比例动态调整价格：' },
            {
                type: 'list', items: [
                    '供需比例 = (实际需求 + 虚拟需求) / 供应量',
                    '虚拟需求 = 幸存者 × virtualDemandPerPop（模拟市场基础需求）',
            ...
            {
                type: 'list', items: [
                    '罐头：目标30天，影响0.15（战略储备，价格稳定）',
                    '装甲板：目标10天，影响0.4（非必需品，价格敏感）',
            ...
            {
                type: 'list', items: [
                    '基础必需品（罐头）：低波动权重 + 高库存目标 = 价格稳定',
                    '奢侈品（装甲板）：高波动权重 + 低库存目标 = 价格敏感',
                    '工业品：中等配置，平衡稳定度和市场反应',
                    '虚拟资源（研究、士气）：特殊配置，不受市场影响',
                    '策划可以为每个资源和建筑定制经济特性'
                ]
            },
    ...
    },
    {
        ...
        name: '幸存者与阶层流动',
        icon: 'Users',
        summary: '幸存者增长、职业转换与满意度影响',
        content: [
            { type: 'h4', text: '1. 幸存者增长机制' },
            { type: 'p', text: '幸存者不会凭空暴涨，需要满足以下条件才会自然增长：' },
            {
                type: 'list', items: [
                    '住房充足：当前幸存者 < 幸存者上限 (MaxPop)。建造房屋可提升上限。',
                    '罐头盈余：当前罐头库存 > 幸存者数 × 1.5。',
                    '社会稳定：稳定度越高，幸存者增长概率越大。',
                    '反之，如果罐头耗尽 (0)，幸存者会发生饥荒并减少。'
                ]
            },
            ...
            {
                type: 'list', items: [
                    '自动填补：当有空缺岗位时，失业幸存者会自动填补。',
                    '跳槽逻辑：如果某个职业的"潜在收入"（工资+资源出售收益）远高于当前职业，且目标职业有空缺，幸存者会辞职并转职。',
                    '财富携带：转职时，他们会带走自己积累的财富。',
                    '转职冷却：幸存者不会频繁跳槽，有一定的稳定期。'
                ]
            },
            ...
            {
                type: 'list', items: [
                    '物资需求：这是最关键的因素。满足日常需求（如商贩的稀有物资、工人的工具）能大幅提升好感。',
                    '税率影响：低税率提升好感，高税率降低好感。',
                    '如果好感度过低且该阶层影响力大，可能导致幸存者外流（带着财富离开）甚至叛乱。',
                    '高好感度会提供强大的加成：种植员提升采集效率、工匠提升生产效率、学者提升研究等。'
                ]
            },
            { type: 'h4', text: '4. 阶层影响力' },
            { type: 'p', text: '每个阶层的影响力由幸存者数量和财富决定：' },
            {
                type: 'list', items: [
                    '影响力高的阶层对国家政策有更大发言权',
                    '区长和军阀的影响力通常较高',
            ...
            { type: 'p', text: '随着阶层积累财富，他们会陷入“财富陷阱”——变得更难取悦：' },
            {
                type: 'list', items: [
                    ...
                    '如：种植员开始需要稀有物资，工人需要兴奋剂，区长需要鲜肉和防护服',
            ...
            {
                type: 'list', items: [
                    '商贩：控制贸易网络，高影响力，初始财富500',
                    '管理者：政府管理者，高影响力，初始财富400',
                    '区长：传统精英，掌控土地和农业，初始财富800',
                    '军阀：工业精英，提供投资和工业加成，初始财富1200',
            ...
            { type: 'h5', text: '中产阶级' },
            {
                type: 'list', items: [
                    ...
                    '军人：维护国家安全，初始财富180',
                    '宣传员：提供信仰和士气，安抚民心，初始财富220',
                    '学者：记录知识的学者，为图书馆服务，初始财富250',
                    '水手：病毒研究的海员，推动航海扩张，初始财富300'
                ]
            },
            { type: 'h5', text: '下层阶级' },
            {
                type: 'list', items: [
                    '种植员：社会基础，提供罐头和兵源，初始财富80',
                    '难民：依附于区长的种植员，产出归区长，初始财富50',
                    '拾荒者：专职砍伐废材，初始财富90',
                    '工人：重建文明的基石，初始财富150',
                    '矿工：深入地下采集矿石，初始财富120',
                    '流浪者：暂时没有工作的平民，初始财富30'
                ]
            },
    ...
    },
    {
        ...
        content: [
            ...
            { type: 'p', text: '最危险的时刻：如果多个阶层同时处于高组织度状态，他们会放下成见，通过“人民联合阵线”共同发动叛乱。联合叛军拥有庞大的幸存者和财富，极难对付。' },
            { type: 'h4', text: '3. 应对策略' },
            { type: 'p', text: '点击左侧“幸存者角色”面板，进入详情页使用策略行动：' },
            {
                type: 'list', items: [
                    '安抚：发放补贴或公开表态，消耗信用点或稳定度换取时间',
                    '分化：挑拨离间，降低组织度',
    ...
    },
    {
        ...
        content: [
            ...
            { type: 'p', text: '此外，幸存者角色（如军人）的满意度会提供全局战斗Buff。' },
            { type: 'h4', text: '3. 军队管理' },
            {
                type: 'list', items: [
                    '幸存者限制：军队幸存者不能超过总幸存者的30%',
                    '维护成本：每个单位每秒消耗资源（罐头、黄金等）',
                    '训练时间：高级单位需要更长的训练时间',
    ...
    },
    {
        ...
        content: [
            { type: 'h4', text: '⚔️ 主动出击' },
            { type: 'p', text: '除了防御，你可以对敌国发起多种类型的战斗行动：' },
            { type: 'h4', text: '1. 行动类型' },
            {
                type: 'list', items: [
                    '边境掠夺 (Raid)：低风险。派遣小股部队袭扰，主要抢夺罐头和废材。适合前期积累。',
                    '正面攻势 (Assault)：中风险。寻求与敌军主力决战，削减敌方军力，缴获武器和金属。',
                    '围城压制 (Siege)：高风险高回报。攻陷敌方城市，掠夺物资库信用点、工业品甚至士气研究成果。',
                    '海上劫掠 (Naval Raid)：针对敌方贸易线，截获稀有物资、兴奋剂等珍稀贸易品。',
                    '焦土战术 (Scorched Earth)：旨在破坏敌方经济潜力（幸存者/田地），自身收益低但对敌打击大。'
                ]
            },
            { type: 'h4', text: '2. 战利品机制' },
            {
                type: 'list', items: [
                    ...
                    '有的放矢：缺粮就去“掠夺”，缺钱就去“围城”，缺稀有物资就去“海盗”。'
                ]
            }
        ]
    },
        ...
        content: [
            ...
            { type: 'p', text: '每次升级时代都会获得永久性的全局加成：' },
            {
                type: 'list', items: EPOCHS.slice(1).map(epoch => {
                    ...
                    if (b.militaryBonus) parts.push(`战斗力量+${(b.militaryBonus * 100).toFixed(0)}%`);
                    if (b.cultureBonus) parts.push(`士气产出+${(b.cultureBonus * 100).toFixed(0)}%`);
                    if (b.scienceBonus) parts.push(`研究产出+${(b.scienceBonus * 100).toFixed(0)}%`);
                    ...
                    if (b.maxPop) parts.push(`幸存者上限+${(b.maxPop * 100).toFixed(0)}%`);
        ...
        content: [
            ...
            { type: 'p', text: '战争不再是无休止的消耗，而是通过“战争分数”来结算：' },
            {
                type: 'list', items: [
                    ...
                    '索取：分数领先时，你可以主动提出和平条款，索要信用点、资源或割地'
                ]
            },
            ...
            { type: 'p', text: '彻底征服一个国家的终极手段：' },
            {
                type: 'list', items: [
                    ...
                    '吞并效果：获得敌国所有剩余幸存者、并将你的幸存者上限直接增加等量数值',
                    '后果：敌国将从地图上永久抹除，并在外联史上留下浓重一笔'
                ]
            },
            { type: 'h4', text: '4. 国家灭亡' },
            { type: 'p', text: '除了被吞并，如果一个国家的幸存者因战争消耗或饥荒降为0，它也会自动灭亡。残存的流民可能会逃入你的国家。' }
        ]
    },
    {
        id: 'mech_decrees',
        ...
        content: [
            ...
            {
                type: 'list', items: [
                    '强制劳动：生产+30%，但种植员好感度-20',
                    '自由贸易：贸易收益+25%，但税收-10%',
                    '征兵法：军队招募速度+50%，但幸存者增长-20%',
                    '公共教育：研究+30%，但维护成本增加',
                    '需要权衡利弊选择合适的政令'
                ]
            },
        ...
        content: [
            { type: 'h4', text: '1. 建筑类别' },
            {
                type: 'list', items: [
                    ...
                    '民生建筑：房屋、市场、图书馆等，提供幸存者和服务',
                    '战斗建筑：训练营、马厩、攻城工坊等，训练军队'
                ]
            },
            { type: 'h4', text: '2. 生产机制' },
            {
            ...
            {
                type: 'list', items: [
                    '基础资源：罐头、废材、碎石（采集建筑生产）',
                    '加工资源：木板、零件、工具（工业建筑加工）',
                    '高级资源：奢侈品、士气、研究（特殊建筑产出）',
                    '幸存者消耗：所有幸存者都需要罐头维持',
                    '阶层需求：不同阶层需要不同的物资（如商贩需要稀有物资）'
                ]
            },
            { type: 'h4', text: '4. 建筑策略' },
            {
                type: 'list', items: [
                    '前期：优先建造采集建筑和房屋，确保基础资源和幸存者',
                    '中期：建造工业建筑形成生产链，提升资源价值',
                    '后期：建造高级建筑产出士气、研究等虚拟资源',
    ...
    },
    {
        ...
        content: [
            ...
            {
                type: 'list', items: [
                    '短期效果：持续1年，数值较高（如研究+50%）',
                    '永久效果：永久生效，数值较低（如研究+10%）',
                    '不同时代有不同的庆典选项'
                ]
            },
            { type: 'h4', text: '3. 庆典效果' },
            ...
            { type: 'h4', text: '4. 选择策略' },
            {
                type: 'list', items: [
                    '前期：选择资源产出加成快速发展',
                    '中期：根据发展方向选择（战斗/经济/士气）',
                    '后期：优先选择永久效果累积优势',
                    '短期效果适合应急（如准备战争时选战斗加成）',
                    '永久效果适合长期发展（如研究+10%永久）'
                ]
            },
            { type: 'h4', text: '5. 庆典示例' },
            {
        ...
        content: [
            { type: 'h4', text: '1. 经济优化' },
            {
                type: 'list', items: [
                    ...
                    '产业链：建立完整的生产链（如废材→木板→装甲板）提升价值',
                    '税收平衡：适度征税避免阶层不满，同时保证财政收入',
                    '商贩系统：建造贸易站让商贩自动交易赚取利润',
                    '市场调控：通过进出口调节国内资源价格'
                ]
            },
            { type: 'h4', text: '2. 战斗策略' },
    ...
    },
    {
        ...
        content: [
            { type: 'h4', text: '👑 执政联盟系统' },
            { type: 'p', text: '执政联盟是你选择与哪些幸存者角色共同执政的核心政治系统。联盟的组成直接影响政府的合法性和税收效率。' },
            ...
            {
                type: 'list', items: [
                    '【封建区长专制】区长独揽 → 采集+15%，农田产出+20%',
                    '【垄断资本独裁】军阀独占 → 工业+20%，税收+15%',
                    '【官僚集权】管理者垄断 → 生产+10%，税收+12%，士气+8%',
                    '【商业寡头政治】商贩掌控 → 市场/贸易港产出+25%，税收+15%',
                    '【神权政治】宣传员管理 → 士气+25%，稳定+10%，研究-15%',
                    '【军人专政】军人独揽 → 战斗+30%，稳定-5%',
                    '【工人无产阶级专政】工人阶级 → 工业+18%，工人消费-12%，税收-10%',
                    '【种植员专政】种植员阶级 → 采集+20%，农田产出+18%',
                    '【技术官僚政治】工程师主导 → 研究+25%，工业+12%',
                    '【学者治国】知识分子掌权 → 研究+20%，士气+15%，战斗-10%',
            ...
            {
                type: 'list', items: [
                    '【工农联合政府】工人+种植员 → 采集+12%，工业+10%，消费-8%',
                    '【人民民主专政】工农为基础，无产阶级≥70% → 采集+10%，工业+12%，消费-15%',
                    '【资产阶级共和国】资产阶级≥60%，含工人/工匠 → 工业+15%，税收+12%',
                    '【资本主义寡头政治】资产阶级≥60%，无区长 → 工业+18%，税收+18%',
                    '【封建神权联盟】区长≥60%，含神职 → 采集+12%，士气+15%，稳定+8%，研究-10%',
                    '【区长寡头政治】区长≥60% → 采集+10%，税收+12%',
                    '【战斗-精英联盟】战斗≥50%，含军阀/区长 → 战斗+20%，税收+8%',
                    '【军人政府】战斗≥50% → 战斗+22%，稳定-3%',
                    '【技术精英政府】含学者+工程师 → 研究+18%，工业+10%'
                ]
            },
            { type: 'h5', text: '🌍 大联盟政体（5个以上阶层）' },
            {
                type: 'list', items: [
                    ...
                    '【民族团结政府】≥5阶层，含上/中/下层 → 生产+5%，稳定+10%，幸存者上限+15',
            ...
            {
                type: 'list', items: [
                    '【工业资本主义政府】工业阶层≥60%，含军阀 → 工业+20%，税收+12%',
                    '【劳工联合政府】工业阶层≥60%，含工人/工匠 → 工业+15%，消费-8%',
                    '【区长-种植员联盟】农业阶层≥60%，含区长 → 采集+18%，食物需求-8%',
                    '【种植员政府】农业阶层≥60%，无产阶级≥50% → 采集+18%，食物需求-10%',
        ...
        content: [
            ...
            { type: 'h4', text: '3. 升级成本' },
            {
                type: 'list', items: [
                    '升级需要支付资源和信用点',
                    '1级升级成本较低，2级升级成本较高',
                    '成本通常包括：基础资源、加工资源、工具、信用点',
                    '示例：农田升级1级需要废材50、碎石20、工具5、信用点300'
                ]
            },
            { type: 'h4', text: '4. 升级操作' },
            {
            ...
            { type: 'h4', text: '6. 升级示例' },
            {
                type: 'list', items: [
                    ...
                    '伐木场→大伐木场→林场：产出2.56→3.33→4.61废材',
                    '采石场→深坑采石场→大采石场：产出2.0→2.6→3.6碎石',
                    '图书馆→学堂→书院：产出0.8→1.04→1.44研究'
                ]
            }
        ]
    },
    {
        ...
        content: [
            ...
            {
                type: 'list', items: [
                    '底层阶层（种植员、难民、流浪者）：0.3-0.5（收入翻倍，消费只增30-50%）',
                    '中层阶层（工人、工匠、矿工）：0.6-0.8（消费增长适中）',
                    '商业阶层（商贩）：1.5（收入转化消费能力很强）',
                    '上层阶层（军阀、区长）：1.4-1.8（消费增长最快）'
                ]
            },
            ...
            {
                type: 'list', items: [
                    '种植员/难民：从基本工具和麦酒开始，逐渐需要稀有物资、装甲板',
                    '工人/工匠：需要更多工具、兴奋剂、防护服',
                    '商贩：高消费群体，需要大量鲜肉、稀有物资、士气',
                    '区长/军阀：需要全品类奢侈品，是消费市场的主力',
                    '学者/管理者：偏好情报、兴奋剂、士气类消费'
                ]
            },
            { type: 'h4', text: '6. 策略建议' },
            {
    ...
    },
    {
        ...
        name: '进出口与商贩贸易',
        icon: 'Ship',
        summary: '国际贸易路线与商贩自动交易',
        content: [
            { type: 'h4', text: '🚢 贸易系统概述' },
            { type: 'p', text: '贸易是获取稀缺资源和赚取利润的重要途径。包括国际贸易和商贩自动交易两个部分。' },
            ...
            { type: 'h4', text: '3. 商贩阶层贸易' },
            { type: 'p', text: '商贩阶层会自动进行贸易活动，为国家创造财富：' },
            {
                type: 'list', items: [
                    '商贩会买入低价资源，等待价格上涨后卖出',
                    '交易周期：买入后等待3个游戏日',
...
const CATEGORY_CONFIG = [
    ...
    { id: 'economy', label: '幸存者角色', icon: 'Users' },
    { id: 'buildings', label: '建筑设施', icon: 'Home' },
    { id: 'military', label: '战斗单位', icon: 'Shield' },
            ...
            if (cond.exactCoalition) {
                ...
                if (cond.minCategoryShare) {
                    Object.entries(cond.minCategoryShare).forEach(([cat, val]) => {
                        const catNames = { aristocracy: '区长', bourgeoisie: '资产阶级', proletariat: '无产阶级', military: '战斗', agrarian: '农业', industrial: '工业', commercial: '商业' };
...
const flattenEffects = (source, prefix = '', options = {}) => {
    ...
    if (typeof source === 'object') {
        return Object.entries(source).flatMap(([key, value]) => {
            ...
            else if (key === 'scienceBonus' || key === 'science') cnKey = '研究产出';
            else if (key === 'cultureBonus') cnKey = '士气产出';
            else if (key === 'industry') cnKey = '工业效率';
            else if (key === 'gather') cnKey = '采集效率';
            else if (key === 'maxPop') cnKey = '幸存者上限';
            else if (key === 'resourcePercent') cnKey = '资源储量变化';
            else if (key === 'populationPercent') cnKey = '幸存者总量变化';
            ...
            else if (key === 'nationRelation') cnKey = '外联关系变化';
...
const renderEconomyDetails = (data) => {
    const rows = [
        ...
        data.headTaxBase !== undefined && { label: '人头税基准', value: `${formatNumber(data.headTaxBase)} 信用点/日` },
        ...
        data.startingWealth !== undefined && { label: '初始财富', value: `${formatNumber(data.startingWealth)} 信用点` },
...
const renderMilitaryDetails = (data) => {
    const rows = [
        ...
        data.populationCost !== undefined && { label: '幸存者占用', value: formatNumber(data.populationCost) },
...
const renderTechDetails = (data) => {
    ...
    return (
        <div className="space-y-4">
            ...
            <InfoGrid rows={rows} />
            {renderResourceSection('研究成本', data.cost)}
...
const renderDecreeDetails = (data) => {
    const rows = [
        data.category && { label: '政令类别', value: data.category === 'economy' ? '经济' : data.category === 'military' ? '战斗' : data.category === 'culture' ? '士气' : '社会' },
...
const renderResourceDetails = (data) => {
    const rows = [
        data.basePrice !== undefined && { label: '基础价格', value: `${formatNumber(data.basePrice)} 信用点` },
...
const buildTriggerConditionLines = (conditions) => {
    ...
    if (minScience !== undefined) {
        lines.push(`研究储备：≥ ${formatNumber(minScience)}`);
    }
    ...
    if (classConditions && typeof classConditions === 'object') {
        Object.entries(classConditions).forEach(([stratumId, cond]) => {
            ...
            if (cond.minPop !== undefined || cond.maxPop !== undefined) {
                if (cond.minPop !== undefined && cond.maxPop !== undefined) {
                    parts.push(`幸存者在 ${cond.minPop}–${cond.maxPop} 之间`);
                } else if (cond.minPop !== undefined) {
                    parts.push(`幸存者≥${cond.minPop}`);
                } else if (cond.maxPop !== undefined) {
                    parts.push(`幸存者≤${cond.maxPop}`);
                }
            }
