...
const TRADE_POLICY_OPTIONS = [
    ...
    },
    {
        id: 'preferential',
        title: '优惠准入',
        description: '你的商贩享有优先贸易权，并有10%的强制价格优势，关税减免50%',
        effects: '维持现状（默认）',
        effectColor: 'text-gray-400',
        independenceChange: 0,
    },
    {
        id: 'monopoly',
        title: '垄断贸易',
        description: '强制附庸所有贸易通过你的商贩，并有25%的强制价格优势，关税全免',
        effects: '独立倾向增速+30%',
        effectColor: 'text-red-400',
...
const OfficialSelector = memo(({
    ...
    return (
        <div className="space-y-2">
            <label className="text-xs text-gray-400 font-body">选择总督管理者</label>
            <select
