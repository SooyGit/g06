        ...
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-[9999]">
            <div className="bg-gray-900 border-2 border-red-500/50 rounded-lg p-4 max-w-lg w-full mx-4 shadow-2xl max-h-[90vh] flex flex-col">
                ...
                <div className="flex items-center gap-2 mb-3 flex-shrink-0">
                    ...
                    <div>
                        <h2 className="text-base font-bold text-red-400">管理者编制超额</h2>
                        <p className="text-xs text-gray-400">必须解雇部分管理者以符合新的编制限制</p>
                    </div>
                </div>
                ...
                <div className="bg-red-900/20 border border-red-500/30 rounded-lg p-3 mb-3 flex-shrink-0">
                    <p className="text-sm text-gray-300">
                        由于政体变更或其他原因，管理者编制从 <span className="text-white font-bold">{currentCount}</span> 人
                        降低至 <span className="text-white font-bold">{maxCapacity}</span> 人。
                    </p>
                    <p className="text-sm text-red-400 mt-2">
                        您需要解雇 <span className="font-bold">{excessCount}</span> 名管理者。
                        {needToFire > 0 ? (
                            <span className="ml-1">还需选择 <span className="font-bold">{needToFire}</span> 人</span>
                        ) : (
                            <span className="ml-1 text-green-400">已选择足够管理者</span>
                        )}
                    </p>
                </div>
                ...
                >
                    {canClose ? (
                        <span className="flex items-center justify-center gap-2">
                            ...
                            确认解雇 {selectedIds.size} 名管理者
                        </span>
                    ) : (
                        <span>请选择要解雇的管理者</span>
                    )}
                </button>
            </div>
        </div>
