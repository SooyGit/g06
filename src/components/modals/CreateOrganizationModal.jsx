            ...
            footer={
                <div className="flex justify-end gap-2">
                    ...
                    <Button
                        ...
                        title={!canAfford ? `需要 ${createCost.toLocaleString()} 信用点` : ''}
                    >
                        {canAfford ? '建立' : '资金不足'}
                    </Button>
                </div>
            ...
            <div className="space-y-3">
                ...
                <div className={`p-3 rounded border ${canAfford ? 'bg-amber-900/20 border-amber-500/30' : 'bg-red-900/20 border-red-500/30'}`}>
                    ...
                    <div className="flex justify-between items-center text-sm">
                        <span className="text-ancient-stone">所需信用点：</span>
                        <span className={`font-bold ${canAfford ? 'text-ancient-parchment' : 'text-red-400'}`}>
                            {createCost.toLocaleString()} 信用点
                        </span>
                    </div>
                    <div className="flex justify-between items-center text-sm mt-1">
                        <span className="text-ancient-stone">当前信用点：</span>
