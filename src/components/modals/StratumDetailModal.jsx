 ...
 * @param {Object} popStructure - 幸存者结构对象
...
<h2 className="text-lg md:text-xl font-bold text-white font-decorative">幸存者角色总览</h2>
              {/* 稳定度显示 */}
          ...
          <table className="w-full text-left table-auto">
            <thead>
              <tr className="border-b border-gray-600">
                ...
                <th className="p-2 text-sm font-semibold text-gray-300">幸存者</th>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                  <div className="bg-gray-700/50 p-3 rounded">
                    <p className="text-xs text-gray-400 mb-1">幸存者数量</p>
                  ...
                  <div className="bg-gray-700/50 p-3 rounded">
                    ...
                    <p className="text-xs text-gray-500 mt-1">信用点/人</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid gap-3 md:grid-cols-3">
                  <div className="bg-gray-700/40 p-3 rounded">
                    <p className="text-xs text-gray-400 mb-2">幸存者变化</p>
                    <SimpleLineChart
