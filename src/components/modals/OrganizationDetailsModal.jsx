                        ...
                        <div className="space-y-1 text-xs">
                            <div className="flex justify-between items-center">
                                ...
                                <span className={`font-bold ${canAffordLeave ? 'text-ancient-parchment' : 'text-red-400'}`}>
                                    {leaveCostInfo.cost.toLocaleString()} 信用点
                            ...
                            {leaveCostInfo.willDisband && (
                                <div className="mt-2 p-2 bg-red-900/30 rounded border border-red-500/40 text-red-300 text-xs">
                                    ...
                                    <strong>警告：</strong>作为创始国退出将导致组织<strong>解散</strong>！所有成员将受到外联惩罚。
                                </div>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="p-2.5 rounded-lg border bg-blue-900/20 border-blue-500/30">
                        ...
                        <div className="mt-2">
                            <div className="text-xs text-ancient-stone space-y-1.5">
                                <div>
                                    加入国际组织需要通过外联谈判。请前往创始国的外联界面，选择"战斗同盟"或"经济共同体"条约类型，然后选择"申请加入该组织"。
                                </div>
                                ...
                                {organization?.type === 'economic_bloc' && (
                                    <div className="rounded border border-amber-500/30 bg-black/30 p-2">
                                        ...
                                        <div>• 若你是“傀儡附庸/外联受控”，则不能独立申请加入组织</div>
                                    </div>
                                )}
                            </div>
                        </div>
                ...
                <div className="flex justify-end gap-2 pt-2 border-t border-ancient-gold/10">
                    ...
                    {isMember ? (
                        <Button
                            ...
                            title={!canAffordLeave ? `需要 ${leaveCostInfo?.cost?.toLocaleString()} 信用点` : ''}
                        >
