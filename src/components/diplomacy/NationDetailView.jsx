...
const NationDetailView = ({
    ...
    const declareWarDesc = sharedMilitaryAlliance
        ? `无法宣战：同属战斗组织 ${sharedMilitaryAlliance.name}，需先退出。`
...
<h2 className="text-xl md:text-2xl font-bold text-theme-accent tracking-wide font-decorative shadow-black drop-shadow-md">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
                    <StatCard icon="Users" label="幸存者" value={formatStat(nation.population)} color="text-blue-300" />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                        <ActionCard
                            ...
                            desc={giftCooldown.isOnCooldown
                                ...
                                : "提升关系 (+10)，需要信用点。"}
                            cost={`信用点 ${formatCost(giftCostValue)}`}
                        ...
                        <ActionCard
                            ...
                            desc={provokeCooldown.isOnCooldown
                                ...
                                : "消耗信用点离间其与其他国家的关系。"}
                            cost={`信用点 ${formatCost(provokeCostValue)}`}
                            onClick={() => onProvoke?.()}
                            color="orange"
                    ...
                    <div className="flex flex-wrap gap-2">
                        {(() => {
                            ...
                            if (nation.culturalTraits) {
                                ...
                                const TRAIT_MAPPING = {
                                    militaryFocus: { label: '注重战斗', color: 'text-red-300 border-red-800 bg-red-900/40' },
                                    militaryTradition: { label: '战斗传统', color: 'text-red-300 border-red-800 bg-red-900/40' },
                                    ...
                                    culturalHegemony: { label: '士气霸权', color: 'text-purple-300 border-purple-800 bg-purple-900/40' },
                                    philosophyCenter: { label: '哲学中心', color: 'text-purple-300 border-purple-800 bg-purple-900/40' },

                                    raidingCulture: { label: '掠夺士气', color: 'text-orange-400 border-orange-800 bg-orange-900/40' },
...
<Card className="p-4 bg-red-900/10 border-red-500/30">
                ...
                <p className="text-ancient-stone text-sm mb-4">你是该国的附庸，外联行动受限。</p>
                <Button
...
const treatyTypeToLabel = (type) => {
    const map = {
        ...
        military_access: '战斗通行条约',
        defensive_pact: '防御协定',
        alliance: '战斗同盟',
        military_alliance: '战斗同盟', // Organization type - should be filtered out, but add mapping for safety
        peace_treaty: '和平条约',
        open_market: '开放市场',
