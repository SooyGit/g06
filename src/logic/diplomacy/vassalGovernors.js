 ...
 * 总督系统：将管理者能力与附庸国治理深度整合
 * 
 * 管理者属性影响：
 * - Prestige (威望): 独立倾向压制、精英阶层满意度
 * - Administrative (管理): 朝贡效率、腐败减少
 * - Military (战斗): 稳定性、叛乱压制
...
export const GOVERNOR_MANDATES = {
    ...
    exploit: {
        ...
        statFocus: 'administrative', // 管理属性收益翻倍
...
export const GOVERNOR_EFFECTS_CONFIG = {
    ...
    // 管理能力加成
    administrative: {
        tributePerPoint: 0.02,       // [Boosted] 每点管理 +2% 朝贡收入 (was 1%)
    ...
    // 战斗能力加成
    military: {
        stabilityPerPoint: 0.05,     // [Boosted] 每点战斗 +5% 稳定性
        unrestSuppressionPerPoint: 0.05, // [Boosted] 每点战斗 -5% 动荡
    },
...
/**
 * 计算总督的完整效果
 * @param {Object} official - 分配的管理者对象
...
export const calculateGovernorFullEffects = (official, vassalNation = {}) => {
    ...
    const diplomacy = official.stats?.diplomacy ?? official.diplomacy ?? 30; // 新增外联属性
 ...
 * 获取指定附庸的总督管理者对象
 * @param {Object} nation - 附庸国家对象
 * @param {Array} officials - 所有管理者列表
 * @returns {Object|null} 总督管理者对象或null
 */
