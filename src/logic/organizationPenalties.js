...
export const ORGANIZATION_PENALTIES = {
    ...
    merchant: {
        ...
        60: {
            ...
            effects: {
                ...
                treasuryLoss: 0.005, // 每日流失0.5%物资库信用点
            },
        },
    },
    ...
    capitalist: {
        ...
        60: {
            ...
            effects: {
                ...
                treasuryLoss: 0.01, // 每日流失1%物资库信用点
            },
        },
    },
    ...
    soldier: {
        ...
        60: {
            ...
            effects: {
                militaryPower: -0.50,
                militaryDisabled: true, // 无法执行战斗行动
            },
        },
    },
...
export function calculateAllPenalties(organizationStates) {
    const result = {
        ...
        treasuryLoss: 0,         // 每日物资库流失率
        militaryPower: 0,        // 战斗力量修正
        militaryDisabled: false, // 战斗行动禁用
        stabilityDrain: 0,       // 每日稳定度流失
        buildingCost: 0,         // 建筑成本增加
        tradeDisruption: 0,      // 贸易干扰
        populationDrain: 0,      // 幸存者流失率
