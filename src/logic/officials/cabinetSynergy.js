...
// 主导触发阈值
export const DOMINANCE_THRESHOLD = 0.6; // 60% 管理者为同一派系
...
export const REFORM_DECREES = {
    ...
    migrationIncentive: {
        ...
        cost: 400,
        effects: {
            populationGrowth: 0.15, // 幸存者增长 +15%
        },
        description: '幸存者增长 +15%',
    },
    militaryMobilization: {
        ...
        cost: 600,
        effects: {
            militaryBonus: 0.25, // 战斗力量 +25%
            stability: -0.05, // 稳定度下降
        },
        description: '战斗力量 +25%，稳定度下降',
    },
    taxHoliday: {
        id: 'taxHoliday',
        name: '税收减免',
...
// 主导系统需要的最低条件
export const DOMINANCE_MIN_EPOCH = 5; // 疫苗突破
export const DOMINANCE_MIN_OFFICIAL_RATIO = 0.5; // 管理者数量需达到编制的50%
...
/**
 * 计算阶层配额调整效果
 * @param {Object} currentDistribution - 当前幸存者分布 { stratum: population }
 ...
 * @param {Object} params.resources - 资源对象（用于政府支出时扣除信用点）
