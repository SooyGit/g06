...
export const DIPLOMACY_ERA_UNLOCK = {
    treaties: {
        peace_treaty: { minEra: 1, name: '停战协议' },
        non_aggression: { minEra: 2, name: '互不侵犯协议' },
        trade_agreement: { minEra: 2, name: '物资交换协定' },
        free_trade: { minEra: 4, name: '自由物资交换协定' },
    ...
    organizations: {
        military_alliance: { minEra: 3, name: '战斗联盟' },
        economic_bloc: { minEra: 5, name: '经济共同体' },
    },
    economy: {
        merchant_stationing: { minEra: 3, name: '商贩驻留' },
...
export const TREATY_TYPE_LABELS = {
    peace_treaty: '停战协议',
    non_aggression: '互不侵犯',
    trade_agreement: '物资交换协定',
    free_trade: '自由物资交换',
    investment_pact: '投资协议',
    open_market: '开放市场',
    academic_exchange: '学术交流',
    defensive_pact: '共同防御',
    military_alliance: '战斗同盟',
    economic_bloc: '经济共同体',
};
...
/**
 * 获取物资交换政策对价格的修正
 * @param {string} tradePolicyId - 物资交换政策ID
 ...
 * @param {Object} overlordMilitary - 宗主战斗力量
 ...
 *   2. 控制政策压力：劳工、物资交换、治理、战斗、投资政策各有每日影响
 *   3. 阶层满意度：低于50%增加独立倾向，高于50%降低
 *   4. 经济状况：富裕增加独立野心，贫穷依赖宗主
 *   5. 朝贡负担：高朝贡率增加独立倾向
 *   6. 控制措施：总督、驻守、经济援助、士气同化可降低独立倾向
 * 
 * 保留此配置仅为向后兼容
 */
...
export const ERA_PROGRESSION_EFFECTS = {
    ...
    treatyEfficiency: {
        baseDurationBonus: 0,
        perEraDurationBonus: 0.1,   // 每个时代协议基础时长+10%
