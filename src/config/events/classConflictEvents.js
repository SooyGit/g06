...
export const CLASS_CONFLICT_EVENTS = [
  ...
  // --- Historical Neta: French Revolution Style ---
  {
    ...
    icon: 'ShoppingCart',
    image: null,
    description: '城中面包价格一夜之间翻了三倍！愤怒的妇女们聚集在市场上高喊："我们的孩子在挨饿！"商贩们则辩称是罐头歉收所致。一些激进者已经开始砸毁商铺橱窗。',
    triggerConditions: {
      minEpoch: 3,
      minPopulation: 50,
      classConditions: {
    ...
    options: [
      {
        id: 'price_control',
        text: '"面包价格不得超过昨日！"',
        description: '强制实施价格管制，平息民愤但激怒商贩。',
        effects: {
          resourcePercent: {
            silver: -0.012,
          },
      ...
      },
      {
        id: 'open_granary',
        text: '开放物资库粮仓',
        description: '用物资库储备平抑物价，但消耗大量资源。',
        effects: {
          resourcePercent: {
            food: -0.015,
            silver: -0.012,
  ...
  // --- Class Alliance: Workers and Peasants Unite ---
  {
    ...
    icon: 'Users',
    image: null,
    description: '工厂工人和难民代表在酒馆里秘密会面，他们发现彼此面临着相同的困境——低工资、长工时、被剥削。有人提议组建互助会，也有人主张更激进的行动。',
    triggerConditions: {
      minEpoch: 5,
      classConditions: {
        worker: {
    ...
    options: [
      ...
      },
      {
        id: 'divide_and_rule',
        text: '挑拨离间',
        description: '秘密散布谣言，让工人和种植员互相猜疑。',
        effects: {
          resourcePercent: {
            silver: -0.04,
          },
  ...
  // --- Historical Neta: Gracchus Brothers Style Land Reform ---
  {
    ...
    icon: 'Map',
    image: null,
    description: '一位年轻而理想主义的管理者在议会上慷慨陈词："大区长们圈占了祖先的土地，而真正耕种的人却无立锥之地！我提议限制每户土地上限，将多余的分给无地者。"此言一出，议会炸开了锅。',
    triggerConditions: {
      minEpoch: 2,
      classConditions: {
        landowner: {
    ...
    options: [
      {
        id: 'support_reform',
        text: '支持改革！',
        description: '站在种植员一边，强行推动土地重新分配。这将永远改变权力格局。',
        effects: {
          resourcePercent: {
            food: 0.05,
          },
  ...
  // --- Class Conflict: Rich vs Poor Taxation ---
  {
    ...
    icon: 'Coins',
    image: null,
    description: '物资库空虚，财政顾问提出两套方案：一是向所有人征收统一人头税；二是按财富比例征收累进税。富人们强烈反对后者，声称"这是惩罚成功"；而普通民众则高喊"让富人付出应有的份额！"',
    triggerConditions: {
      minEpoch: 4,
      minPopulation: 100,
      classConditions: {
  ...
  // --- Historical Neta: Spartacus Rebellion ---
  {
    ...
    icon: 'Swords',
    image: null,
    description: '一名来自色雷斯的角斗士带领同伴们杀死了看守，逃出了角斗场。他们打出"自由与尊严"的旗号，沿途不断有奴隶、难民甚至破产的自由民加入。这支队伍已经壮大到令人不安的规模。',
    triggerConditions: {
      minEpoch: 2,
      maxEpoch: 3,
      minPopulation: 40,
  ...
  // --- Political Intrigue: Assassination Attempt ---
  {
    ...
    icon: 'AlertTriangle',
    image: null,
    description: '你的密探带来了令人不安的消息：一群不满的区长正在密谋刺杀你。他们认为你的改革损害了他们的利益，只有换一个管理者才能恢复"旧日的秩序"。元老会似乎对此睁一只眼闭一只眼。',
    triggerConditions: {
      minEpoch: 2,
      classConditions: {
        landowner: {
    ...
    options: [
      ...
      },
      {
        ...
        text: '主动示好，寻求和解',
        description: '暂缓改革，安抚区长。但这会被视为软弱。',
        effects: {
          stability: -5,
          approval: {
            landowner: 20,
    ...
    options: [
      {
        ...
        text: '政府紧急注资',
        description: '用物资库资金拯救银行，防止系统性崩溃。',
        effects: {
          resourcePercent: {
            silver: -0.05,
          },
  ...
  // --- Historical Neta: Boston Tea Party Style ---
  {
    ...
    icon: 'Coffee',
    image: null,
    description: '殖民地商贩对新颁布的茶叶垄断令怒不可遏。昨夜，一群化装成原住民的年轻人登上运茶船，将全部茶叶倾倒入海，高喊"无代表不纳税！"。这一行动在各地引发了巨大反响。',
    triggerConditions: {
      minEpoch: 4,
      classConditions: {
        merchant: {
  ...
  // --- Political: Constitutional Crisis ---
  {
    ...
    icon: 'FileText',
    image: null,
    description: '新兴的资产阶级和知识分子联合起来，要求召开制宪会议，限制君主权力，建立代议制政府。传统区长和教士则坚决捍卫旧制度。街头出现了对立的示威人群，国家正处于历史的十字路口。',
    triggerConditions: {
      minEpoch: 5,
      classConditions: {
        capitalist: {
  ...
  // --- Historical Neta: Dreyfus Affair Style ---
  {
    ...
    icon: 'Eye',
    image: null,
    description: '一名来自少数族裔的军官被指控向敌国出卖战斗机密。军方坚称证据确凿，但一些记者和知识分子公开质疑："我控诉！他们在迫害无辜者！"社会分裂成两派，争论异常激烈。',
    triggerConditions: {
      minEpoch: 5,
      classConditions: {
        soldier: {
  ...
  // --- Economic: Monopoly Trust ---
  {
    ...
    icon: 'Briefcase',
    image: null,
    description: '几位最富有的军阀秘密会面后，联合控制了全国的钢铁、铁路和石油供应。他们可以任意定价，竞争者和小商贩纷纷破产。民间开始出现"反托拉斯"的呼声。',
    triggerConditions: {
      minEpoch: 6,
      classConditions: {
        capitalist: {
  ...
  // --- Class Conflict: General Assembly ---
  {
    ...
    icon: 'Landmark',
    image: null,
    description: '财政危机迫使你召开三级会议。但第三等级——商贩、工匠、种植员的代表——要求按人头投票而非按等级投票。"我们代表95%的幸存者，凭什么只有三分之一的投票权？"区长和教士坚决反对。',
    triggerConditions: {
      minEpoch: 4,
      resourcePercent: {
        silver: { max: 200 },
    ...
    options: [
      ...
      },
      {
        ...
        text: '维持传统投票方式',
        description: '安抚区长和教会，但第三等级可能采取激进行动。',
        effects: {
          resourcePercent: {
            silver: 0.012,
          },
  ...
  // --- Class Alliance: Merchant-Scholar Alliance ---
  {
    ...
    icon: 'BookOpen',
    image: null,
    description: '富有的商贩开始资助学者的研究和出版，条件是学者为自由贸易和财产权提供理论辩护。这个联盟正在形成一种新的意识形态力量，挑战传统的土地区长和教会权威。',
    triggerConditions: {
      minEpoch: 5,
      classConditions: {
        merchant: {
    ...
    options: [
      ...
      },
      {
        id: 'cootp_movement',
        text: '收编这股力量',
        description: '任命一些温和派学者为管理者，削弱运动的锋芒。',
        effects: {
          resourcePercent: {
            silver: -0.02,
          },
  ...
  // --- Social: Famine and Distribution ---
  {
    ...
    icon: 'CloudRain',
    image: null,
    description: '连年天灾导致全国性饥荒，饿殍遍野。然而，区长的粮仓里堆满了罐头，商贩正在囤积居奇。愤怒的饥民已经开始抢劫粮车，"打开粮仓，否则我们就自己来！"',
    triggerConditions: {
      minEpoch: 2,
      minPopulation: 50,
      resourcePercent: {
    ...
    options: [
      ...
      },
      {
        id: 'buy_grain',
        text: '用物资库购买罐头',
        description: '高价收购罐头分发，维护市场秩序但财政大出血。',
        effects: {
          resourcePercent: {
            food: 0.015,
            silver: -0.05,
  ...
  // --- Historical Neta: Peasant's Crusade ---
  {
    ...
    icon: 'Cross',
    image: null,
    description: '一位狂热的传教士号召种植员们拿起武器，去夺回圣地。成千上万的种植员响应号召，抛下农田加入这支"神圣军队"。他们装备简陋、缺乏训练，但充满狂热。这对农业生产是灾难性的打击。',
    triggerConditions: {
      minEpoch: 3,
      maxEpoch: 4,
      classConditions: {
    ...
    options: [
      ...
      },
      {
        id: 'ban_movement',
        text: '禁止这场运动',
        description: '强制种植员返回田间，但会激怒教会和信徒。',
        effects: {
          resourcePercent: {
            food: 0.02,
          },
  ...
  // --- Class Conflict: Urban vs Rural ---
  {
    ...
    icon: 'Building',
    image: null,
    description: '城市居民抱怨食品价格太高，要求政府压低农产品价格；种植员则抗议说他们的收成卖不出好价钱，根本无法维持生计。双方的矛盾日益激化，甚至有种植员威胁要停止向城市供粮。',
    triggerConditions: {
      minEpoch: 4,
      classConditions: {
        worker: {
    ...
    options: [
      {
        ...
        text: '补贴种植员',
        description: '用物资库补贴种植员，让他们能以低价卖粮而不亏本。',
        effects: {
          resourcePercent: {
            silver: -0.03,
            food: 0.035,
  ...
  // --- Historical Neta: Opium War Style ---
  {
    ...
    icon: 'AlertTriangle',
    image: null,
    description: '外国商贩大量走私成瘾性药物进入国内，换取你的白银。管理者们争论不休：一派主张严禁，"烟毒害人，必须铲除！"另一派警告说强硬措施可能引发与强大外邦的战争。',
    triggerConditions: {
      minEpoch: 5,
      classConditions: {
        merchant: {
    ...
    options: [
      ...
      },
      {
        ...
        text: '外联谈判',
        description: '尝试通过谈判让外国商贩自愿减少贸易。缓慢但安全。',
        effects: {
          resourcePercent: {
            silver: -0.012,
          },
  ...
  // --- Political: Reformer vs Conservative ---
  {
    ...
    icon: 'Users',
    image: null,
    description: '指挥部中形成了尖锐对立的两派：改革派主张学习外国先进制度，"不变法必亡国！"保守派则坚持祖宗之法不可变，"祖宗自有制度，何须效法蛮夷？"双方互相攻讦，政务几乎瘫痪。',
    triggerConditions: {
      minEpoch: 5,
      classConditions: {
        official: {
  ...
  // --- Workers' Rights Movement ---
  {
    ...
    icon: 'Clock',
    image: null,
    description: '工人们走上街头，高喊"八小时工作、八小时休息、八小时归自己！"他们要求立法限制工作时间。军阀们强烈反对，声称这将摧毁工业竞争力。',
    triggerConditions: {
      minEpoch: 6,
      classConditions: {
        worker: {
  ...
  // --- Historical Neta: Praetorian Guard ---
  {
    ...
    icon: 'Shield',
    image: null,
    description: '禁卫军士兵聚集在宫殿门前，要求发放拖欠的饷银和"登基赏赐"。他们的将领暗示：历史上有很多管理者因为怠慢禁卫军而"意外身亡"。这分明是勒索！',
    triggerConditions: {
      minEpoch: 2,
      classConditions: {
        soldier: {
  ...
  // --- Historical Neta: Magna Carta Style ---
  {
    ...
    icon: 'Scroll',
    image: null,
    description: '联合起来的区长们带着武装随从来到王宫，递上一份文件——他们称之为"自由宪章"。上面列举了对王权的种种限制：未经区长同意不得加税、不得任意逮捕区长、必须保障区长审判权...不签字，他们就不离开。',
    triggerConditions: {
      minEpoch: 3,
      classConditions: {
        landowner: {
    ...
    options: [
      ...
      },
      {
        id: 'delay_and_divide',
        text: '假意接受，暗中分化',
        description: '签字后秘密拉拢部分区长，伺机废除宪章。',
        effects: {
          resourcePercent: {
            silver: -0.02,
          },
  ...
  // --- Class Conflict: Tenant Farmers Strike ---
  {
    ...
    icon: 'Wheat',
    image: null,
    description: '数百名难民拒绝下地干活，他们围坐在区长庄园门前："地租太高了！我们辛苦一年，收成的六成都要交给老爷，剩下的连糊口都难！降租，否则这地我们不种了！"',
    triggerConditions: {
      minEpoch: 3,
      classConditions: {
        peasant: {
  ...
  // --- Economic: Currency Debasement ---
  {
    ...
    icon: 'Coins',
    image: null,
    description: '物资库空虚，财政顾问提出一个"妙计"：在新铸的信用点中掺入更多铜，表面看起来一样，实际含银量减少一半。这样我们就能用同样的银子铸出两倍的钱！但如果被发现...',
    triggerConditions: {
      minEpoch: 2,
      resourcePercent: {
        silver: { max: 150 },
  ...
  // --- Class Alliance: Clergy-Landowner Alliance ---
  {
    ...
    icon: 'Handshake',
    image: null,
    description: '主教大人与大区长们秘密会面后，联合向你施压：他们要求维护教会的免税特权和区长的土地权利，威胁说如果改革继续，他们将联合"保卫传统秩序"。',
    triggerConditions: {
      minEpoch: 3,
      classConditions: {
        cleric: {
  ...
  // --- Political: Succession Crisis ---
  {
    ...
    icon: 'Crown',
    image: null,
    description: '你的两个孩子都声称自己是合法继承人。长子有传统和法律支持，但名声不佳；幼子更受欢迎和有能力，但按照长子继承制没有资格。指挥部分裂成两派，各自支持一方。',
    triggerConditions: {
      minEpoch: 2,
      minStability: 40,
      classConditions: {
  ...
  // --- Historical Neta: Bread Riots ---
  {
    ...
    options: [
      ...
      },
      {
        id: 'blame_hoarders',
        text: '惩罚囤积居奇者',
        description: '将矛头指向商贩和区长，没收他们的罐头。',
        effects: {
          resourcePercent: {
            food: 0.015,
          },
  ...
  // --- Class Conflict: Artisan Guild Politics ---
  {
    ...
    icon: 'Briefcase',
    image: null,
    description: '有人揭发铁匠行会的会长贪污会费、垄断原料、排挤竞争者。普通工匠要求彻查，但会长是有势力的人物，与多位管理者有密切关系。',
    triggerConditions: {
      minEpoch: 3,
      classConditions: {
        artisan: {
  ...
  // --- Historical Neta: Peasant Revolts ---
  {
    ...
    icon: 'Swords',
    image: null,
    description: '长期的剥削终于引爆了种植员的怒火。数千名手持草叉和镰刀的种植员攻占了庄园，烧毁契约，处死了几名特别可恶的区长。他们的领袖——一个自称"大雅克"的人——宣布要"杀光区长"。',
    triggerConditions: {
      minEpoch: 3,
      maxEpoch: 5,
      classConditions: {
  ...
  // --- Modern Era: Labor Union Recognition ---
  {
    ...
    icon: 'Users',
    image: null,
    description: '全国最大的工厂工人联合起来，要求政府承认工会的合法地位。军阀威胁说如果工会合法化，他们就关闭工厂、转移资产。工人代表则警告：如果不承认，将发动全国总罢工。',
    triggerConditions: {
      minEpoch: 6,
      classConditions: {
        worker: {
    ...
    options: [
      {
        ...
        effects: {
          ...
          buildingProductionMod: {
            factory: -0.1, // 工会合法化后，军阀可能会减少投资或生产
            steel_works: -0.1,
          },
        },
      },
  ...
  // --- Historical Neta: Enclosure Movement ---
  {
    ...
    icon: 'Fence',
    image: null,
    description: '大区长们开始用篱笆圈占公共牧场，驱逐在那里放牧了几代人的小农。他们声称这样能提高土地效率。但无数种植员失去了生计，被迫流落到城市寻找工作，或沦为乞丐。',
    triggerConditions: {
      minEpoch: 4,
      classConditions: {
        landowner: {
    ...
    options: [
      ...
      },
      {
        ...
        text: '要求赔偿失地种植员',
        description: '允许圈地但要求区长补偿被驱逐的种植员。',
        effects: {
          resourcePercent: {
            food: 0.03,
          },
  ...
  // --- Political: Free Speech Debate ---
  {
    ...
    icon: 'Newspaper',
    image: null,
    description: '一份报纸刊登了揭露政府腐败的调查报道，引发轩然大波。涉事管理者要求查封报社、逮捕编辑；记者和学者则高呼"真相不能被压制！"。这场争论已经超越了个案，变成了关于新闻自由的原则之争。',
    triggerConditions: {
      minEpoch: 5,
      classConditions: {
        scribe: {
  ...
  // --- Class Conflict: Tax Farmer Abuse ---
  {
    ...
    icon: 'Coins',
    image: null,
    description: '你将征税权外包给了富商——他们预付税款，然后自己去向百姓收取更多以牟利。现在民间怨声载道：包税人勒索、殴打、甚至关押交不起税的种植员。有人开始武力抗税。',
    triggerConditions: {
      minEpoch: 3,
      classConditions: {
        merchant: {
  ...
  // --- Social: Education Reform ---
  {
    ...
    icon: 'GraduationCap',
    image: null,
    description: '改革派提议建立全民免费义务教育制度。教会反对："教育是教会的传统领域！"区长担心："如果种植员的孩子都能读书，谁来种地？"但也有人说："国家的未来取决于民众的素质。"',
    triggerConditions: {
      minEpoch: 5,
      classConditions: {
        scribe: {
