...
export const economicEvents = [
  // ========== 物资交换与商业事件 ==========
  {
    ...
    name: '物资交换繁荣',
    icon: 'Coins',
    description: '远方商队带来了大量货物和金银，市场一片繁荣。商贩们摩拳擦掌，准备大展身手。',
triggerConditions: { minPopulation: 60, minEpoch: 1, maxEpoch: 5 },
...

  {
    ...
    name: '丝路复兴',
    icon: 'Compass',
    description: '通往西域的商路重新开通，丝绸、稀有物资、珠宝源源不断地流入。这是千载难逢的商机！',
triggerConditions: { minPopulation: 120, minEpoch: 2, maxEpoch: 4 },
  ...
  // ========== 农业与罐头事件 ==========
  {
    ...
    name: '丰收庆典',
    icon: 'Wheat',
    description: '今年风调雨顺，五谷丰登。种植员们载歌载舞，庆祝这来之不易的丰收。',
...
triggerConditions: { minPopulation: 70, minEpoch: 1, maxEpoch: 5 },
  ...
  // ========== 消费与奢侈品事件 ==========
  {
    ...
    name: '奢侈风潮',
    icon: 'Sparkles',
    description: '区长们开始追捧来自远方的奢侈品，攀比之风愈演愈烈。',
...
triggerConditions: { minPopulation: 80, minEpoch: 2, maxEpoch: 5 },
...

  {
    ...
    name: '钱庄兴起',
    icon: 'Landmark',
    description: '精明的商贩开始经营钱庄，提供存款和借贷服务。这种新式商业引发了不少争议。',
...
triggerConditions: { minPopulation: 100, minEpoch: 2, maxEpoch: 4 },
  ...
  // ========== 自然资源事件 ==========
  {
    ...
    name: '森林枯竭',
    icon: 'Trees',
    description: '多年的砍伐使得森林面积锐减，废材价格飙升，连柴火都变得稀缺。',
triggerConditions: { minPopulation: 100, minEpoch: 2, maxEpoch: 5 },
    options: [
      {
        id: 'plant_trees',
  ...
  // ========== 国际物资交换事件 ==========
  {
    ...
    name: '外国禁运',
    icon: 'Globe',
    description: '邻国宣布对我国实施物资交换禁运，许多商品无法进口，价格大涨。',
triggerConditions: { minPopulation: 100, minEpoch: 2, maxEpoch: 5 },
    options: [
      {
        id: 'develop_domestic',
...

  {
    ...
    name: '新航路发现',
    icon: 'Ship',
    description: '探险家发现了通往富饶之地的新航路，这将彻底改变物资交换格局。',
...
triggerConditions: { minPopulation: 80, minEpoch: 2, maxEpoch: 5 },
  ...
  // ========== Historical Neta: Tulip Mania Style ==========
  {
    ...
    name: '郁金香狂热',
    icon: 'Flower',
    description: '一种异域花卉突然在区长间风靡，价格疯涨。一颗稀有品种的球茎竟然能换一栋房子！所有人都想从中牟利。',
triggerConditions: { minPopulation: 120, minEpoch: 4, maxEpoch: 5 },
  ...
  // ========== Historical Neta: South Sea Bubble Style ==========
  {
    ...
    name: '南海泡沫',
    icon: 'Ship',
    description: '一家声称垄断远洋物资交换特权的公司股价飙升，连牛顿那样的天才都投入了毕生积蓄。"我能计算天体运行，却算不出人类的疯狂。"',
triggerConditions: { minPopulation: 150, minEpoch: 5, maxEpoch: 6 },
  ...
  // ========== Historical Neta: Hanseatic League Style ==========
  {
    ...
    name: '商贩同盟',
    icon: 'Handshake',
    description: '几个主要港口城市的商贩结成同盟，控制了大部分海上物资交换。他们请求特权，作为回报将为国家提供贷款和舰船。',
triggerConditions: { minPopulation: 120, minEpoch: 3, maxEpoch: 5 },
  ...
  // ========== Historical Neta: East India Company Style ==========
  {
    ...
    name: '特许物资交换公司',
    icon: 'Building',
    description: '富商们请求成立一家特许物资交换公司，垄断与东方/西方的物资交换。他们承诺向王室缴纳丰厚的特许费。',
triggerConditions: { minPopulation: 150, minEpoch: 4, maxEpoch: 6 },
  ...
  // ========== Historical Neta: Coinage Debasement ==========
  {
    ...
    name: '铸币减重',
    icon: 'Coins',
    description: '财政紧张，顾问建议铸造成色不足的货币来应急。"反正百姓也分不出来。"但如果被发现，后果不堪设想。',
    triggerConditions: { minPopulation: 150, minEpoch: 2, maxEpoch: 5 },
    options: [
      {
        id: 'debase_secretly',
  ...
  // ========== Historical Neta: Enclosure Movement Style ==========
  {
    ...
    name: '圈地运动',
    icon: 'Fence',
    description: '区长们请求将公共牧场圈为私有，用于养羊生产羊毛。"羊吃人"的说法开始流传，失地种植员何去何从？',
...
triggerConditions: { minPopulation: 150, minEpoch: 4, maxEpoch: 6 },
  ...
  // 节庆消费高峰
  {
    ...
    name: '节庆旺季',
    icon: 'Gift',
    description: '一年一度的节庆即将到来，各地都在筹备庆典活动。奢侈品需求激增，商贩们摩拳擦掌。',
    triggerConditions: { minPopulation: 80 },
    options: [
      {
  ...
  // 时尚潮流
  {
    ...
    name: '时尚风潮',
    icon: 'Shirt',
    description: '一种新的服饰风格在区长间流行起来，很快蔓延到各个阶层。绷带和药品的需求急剧上升。',
  ...
  // 建筑热潮
  {
    ...
    name: '建筑热潮',
    icon: 'Building2',
    description: '城市扩张和幸存者增长带来了一波建筑热潮。废材、石材和零件的需求大幅上涨。',
  ...
  // 军备竞赛
  {
    ...
    name: '军备竞赛',
    icon: 'Sword',
    description: '邻国正在扩军备战，战斗紧张局势加剧。是否应该增加战斗投入？',
    triggerConditions: { minPopulation: 100, minEpoch: 1 },
    options: [
      {
        id: 'militarize',
  ...
  // 学术繁荣
  {
    ...
    name: '学术繁荣',
    icon: 'BookOpen',
    description: '一场学术运动正在兴起，学者们热衷于著书立说，对情报和文具的需求激增。',
  ...
  // 区长奢靡
  {
    ...
    name: '区长奢靡',
    icon: 'Crown',
    description: '区长们的奢侈消费达到了新高度，攀比之风盛行。这带动了奢侈品产业，但也引发了平民的不满。',
  ...
  // 兴奋剂热
  {
    ...
    name: '兴奋剂热潮',
    icon: 'Coffee',
    description: '兴奋剂馆成为新的社交场所，知识分子和商贩们聚集在此讨论时政。兴奋剂需求急剧上升。',
  ...
  // 装甲板热潮
  {
    ...
    name: '装甲板风尚',
    icon: 'Armchair',
    description: '新式装甲板设计风靡一时，富人们争相更换家中的陈设。木工坊日夜赶工。',
    triggerConditions: { minPopulation: 100, minEpoch: 2 },
    options: [
      {
