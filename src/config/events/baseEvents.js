...
export const BASE_EVENTS = [
    ...
    },
    {
        ...
        icon: 'Users',
        image: null,
        description: '城门外扬起滚滚黄尘，一支驼铃叮当的商队缓缓驶来。骆驼背上堆满了用丝绸包裹的神秘货物，商贩们穿着异域风情的长袍，说着口音奇特的话语。他们带来了来自遥远国度的稀有物资、珠宝和奇闻异事——据说那里的人骑着大象打仗，住在黄金铸成的宫殿里。商队首领恭敬地呈上礼物，请求觐见。',
        triggerConditions: {
            minEpoch: 1,
        },
        options: [
    ...
    },
    {
        ...
        icon: 'Wheat',
        image: null,
        description: '末日降临的农地收成不佳，大量种植员手头拮据，正在聚集到营地边缘向你抱怨。',
        triggerConditions: {
            minEpoch: 0,
            maxEpoch: 0,
            classConditions: {
        ...
        options: [
            ...
            },
            {
                id: 'organize_hunt',
                text: '组织集体狩猎',
                description: '鼓励种植员进入荒野狩猎，以劳动换取补给。',
                effects: {
                    resourcePercent: {
                        food: 0.015,
                    },
        ...
        options: [
            ...
            },
            {
                ...
                effects: {
                    ...
                    resourceDemandMod: {
                        culture: 0.03,    // 礼物交换增加士气需求
                    },
                    stratumDemandMod: {
                        cleric: 0.1,     // 宣传员活动增加（接收礼物）
                    },
                    buildingProductionMod: {
    ...
    },
    {
        ...
        icon: 'Coins',
        image: null,
        description: '青铜器和奢侈品的远途贸易开始兴旺，商贩阶层气焰陡涨。',
        triggerConditions: {
            minEpoch: 1,
            classConditions: {
                merchant: {
        ...
        options: [
            {
                ...
                effects: {
                    ...
                    resourceDemandMod: {
                        spice: 0.15,     // 贸易增加稀有物资需求
                        cloth: 0.1,      // 增加绷带需求
                        delicacies: 0.08, // 增加鲜肉需求
                    },
                    stratumDemandMod: {
                        merchant: 0.2,   // 商贩活动大幅增加
                        peasant: -0.05,  // 种植员活动略微减少（转向贸易）
                    },
                    buildingProductionMod: {
                        market: 0.15,    // 市场活动增加
            ...
            },
            {
                ...
                effects: {
                    ...
                    stratumDemandMod: {
                        merchant: -0.08,   // 商贩活动减少（因税收）
                        peasant: 0.05,     // 种植员活动略微增加
                    },
                    buildingProductionMod: {
            ...
            },
            {
                ...
                effects: {
                    ...
                    resourceDemandMod: {
                        food: -0.08,       // 罐头需求减少（价格稳定）
                        spice: -0.1,       // 稀有物资需求减少（限制商贩）
                    },
                    stratumDemandMod: {
                        merchant: -0.15,   // 商贩活动减少
                        peasant: 0.12,     // 种植员活动增加
                    },
                    buildingProductionMod: {
                        farm: 0.08,        // 农场生产增加（罐头供应稳定）
                        market: -0.1,      // 市场活动减少
                    },
                },
            },
    ...
    },
    {
        ...
        icon: 'BookOpen',
        image: null,
        description: '堡垒建设的城市中出现了学者聚会，他们在公共广场辩论国家走向。',
        triggerConditions: {
            minEpoch: 2,
            minScience: 800,
            classConditions: {
        ...
        options: [
            ...
            },
            {
                ...
                effects: {
                    ...
                    resourceDemandMod: {
                        culture: 0.08,      // 舆论引导增加士气需求
                    },
                    stratumDemandMod: {
                        scribe: 0.08,       // 文士活动增加（舆论工作）
                        peasant: 0.05,      // 种植员参与度增加
                    },
                    buildingProductionMod: {
            ...
            },
            {
                ...
                effects: {
                    ...
                    resourceDemandMod: {
                        culture: -0.1,      // 限制讨论减少士气需求
                        science: -0.08,     // 研究需求减少
                    },
                    stratumDemandMod: {
                        scribe: -0.15,      // 文士活动减少
                        landowner: 0.1,     // 区长活动增加
                    },
                    buildingProductionMod: {
                        library: -0.08,      // 学校活动减少
                    },
    ...
    },
    {
        ...
        icon: 'Castle',
        image: null,
        description: '土地集中在少数区长手中，他们联合起来要求进一步的特权。',
        triggerConditions: {
            minEpoch: 2,
            classConditions: {
                landowner: {
        ...
        options: [
            {
                ...
                effects: {
                    ...
                    resourceDemandMod: {
                        delicacies: 0.12,   // 区长消费奢侈品增加
                        fine_clothes: 0.1,  // 精美服装需求增加
                        furniture: 0.08,    // 装甲板需求增加
                    },
                    stratumDemandMod: {
                        landowner: 0.2,     // 区长活动大幅增加
                        peasant: -0.12,     // 种植员活动减少
                        serf: -0.1,         // 农奴活动减少
                    },
                    buildingProductionMod: { // 区长庄园生产效率下降
                        farm: -0.08,        // 农场生产减少（种植员不满）
            ...
            },
            {
                id: 'balance_reform',
                text: '推动适度土地改革',
                description: '在不激怒区长的前提下，释放部分土地给种植员。',
                effects: {
                    stability: -4,
                    approval: {
                        landowner: -12,
                    ...
                    resourceDemandMod: {
                        tools: 0.08,        // 种植员需要更多农具
                        food: 0.06,         // 种植员罐头需求增加
                    },
                    stratumDemandMod: {
                        landowner: -0.15,   // 区长活动减少
                        peasant: 0.15,      // 种植员活动增加
                    },
                    buildingProductionMod: {
                        farm: 0.08,          // 农场生产增加
                    },
            ...
            },
            {
                ...
                effects: {
                    ...
                    resourceDemandMod: {
                        food: 0.12,         // 种植员获得更多土地，罐头需求增加
                        tools: 0.15,        // 需要更多农具
                    },
                    stratumDemandMod: {
                        landowner: -0.25,   // 区长活动大幅减少
                        peasant: 0.22,      // 种植员活动大幅增加
                    },
                    buildingProductionMod: {
                        farm: 0.15,         // 农场生产大幅增加
                    },
            ...
            },
            {
                ...
                effects: {
                    ...
                    stratumDemandMod: {
                        ...
                        landowner: -0.08,   // 区长活动减少
                        official: 0.1,      // 管理者活动增加（执行登记）
                    },
                },
            },
        ],
        ...
        options: [
            ...
            },
            {
                ...
                effects: {
                    ...
                    stratumDemandMod: {
                        cleric: 0.15,         // 宣传员活动增加（不受约束）
                        peasant: -0.1,        // 种植员活动减少（不满）
                    },
                    buildingProductionMod: {
                        church: 0.12,      // 修道院活动继续
            ...
            },
            {
                ...
                effects: {
                    ...
                    stratumDemandMod: {
                        cleric: -0.12,       // 宣传员活动减少
                        peasant: 0.08,       // 种植员活动略微增加
                        official: 0.06,      // 管理者活动增加（征税）
                    },
                    buildingProductionMod: {
                        church: -0.1,     // 修道院活动减少
                    },
    ...
    },
    {
        ...
        icon: 'Ship',
        image: null,
        description: '少数大商贩控制了远洋航线，垄断了稀有物资与奢侈品的进口。',
        triggerConditions: {
            minEpoch: 4,
            classConditions: {
                merchant: {
        ...
        options: [
            {
                ...
                effects: {
                    ...
                    resourceDemandMod: {
                        spice: 0.18,        // 稀有物资需求增加（垄断公司控制进口）
                        cloth: 0.15,        // 绷带需求增加
                        delicacies: 0.12,   // 鲜肉需求增加
                    },
                    stratumDemandMod: {
                        merchant: 0.22,     // 商贩活动大幅增加
                        peasant: -0.1,      // 种植员活动减少（被排挤）
                        worker: -0.08,      // 工人活动减少
                    },
                    buildingProductionMod: {
            ...
            },
            {
                ...
                effects: {
                    ...
                    resourceDemandMod: {
                        spice: 0.08,        // 稀有物资需求略微增加（更多参与者）
                        cloth: 0.06,        // 绷带需求略微增加
                        delicacies: 0.05,   // 鲜肉需求略微增加
                    },
                    stratumDemandMod: {
                        merchant: -0.18,    // 大商贩活动减少
                        peasant: 0.1,       // 种植员活动增加（更多机会）
                        worker: 0.08,       // 工人活动增加
                    },
                    buildingProductionMod: {
            ...
            },
            {
                ...
                effects: {
                    ...
                    resourceDemandMod: {
                        spice: -0.1,        // 稀有物资需求减少（关税太高）
                        cloth: -0.08,       // 绷带需求减少
                        delicacies: -0.06,  // 鲜肉需求减少
                    },
                    stratumDemandMod: {
                        merchant: -0.12,    // 商贩活动减少（贸易成本增加）
                    },
                    buildingProductionMod: {
        ...
        options: [
            {
                ...
                effects: {
                    ...
                    resourceDemandMod: {
                        papyrus: 0.25,       // 小册子需要情报
                        culture: 0.15,       // 士气需求增加
                        science: 0.12,       // 研究需求增加
                    },
                    stratumDemandMod: {
                        scribe: 0.2,         // 文士活动增加（撰写小册子）
                        peasant: 0.08,       // 种植员阅读需求增加
                        merchant: 0.05,      // 商贩关注思想变化
                    },
                    buildingProductionMod: {
                        school: 0.1,         // 学校活动增加
    ...
    },
    {
        ...
        icon: 'Coffee',
        image: null,
        description: '商贩、工程师和学者聚集在兴奋剂馆中，讨论最新的技术与金融手段。',
        triggerConditions: {
            minEpoch: 5,
            classConditions: {
                merchant: {
        ...
        options: [
            {
                ...
                effects: {
                    ...
                    resourceDemandMod: {
                        coffee: 0.3,         // 兴奋剂馆需要兴奋剂
                        delicacies: 0.15,    // 需要点心
                        papyrus: 0.1,        // 需要情报记录思想
                        science: 0.12,       // 研究需求增加
                    },
                    stratumDemandMod: {
                        merchant: 0.18,      // 商贩活动增加（资助沙龙）
                        engineer: 0.15,      // 工程师活动增加
                        scribe: 0.12,        // 文士活动增加
                        official: 0.05,      // 管理者关注
                    },
                    buildingProductionMod: {
                        coffee_house: 0.2,   // 兴奋剂馆活动增加
                        tavern: 0.1,         // 酒馆活动增加
                        market: 0.08,        // 市场活动增加
                    },
                },
        ...
        options: [
            {
                ...
                effects: {
                    ...
                    stratumDemandMod: {
                        ...
                        capitalist: -0.1,  // 军阀活动减少（成本增加）
                        official: 0.08,    // 管理者活动增加（监督执行）
                    },
                    buildingProductionMod: {
    ...
    },
    {
        ...
        icon: 'Briefcase',
        image: null,
        description: '军阀阶层财富激增，他们开始资助豪华剧院和科学社团。',
        triggerConditions: {
            minEpoch: 6,
            classConditions: {
                capitalist: {
        ...
        options: [
            {
                ...
                effects: {
                    ...
                    resourceDemandMod: {
                        ...
                        furniture: 0.15,     // 装甲板需求增加
                        steel: 0.1,          // 投资工业需要合金
                    },
                    stratumDemandMod: {
                        capitalist: 0.22,    // 军阀活动大幅增加
                        merchant: 0.15,      // 商贩活动增加
    ...
    },
    {
        ...
        icon: 'Waves',
        image: null,
        description: '连日的暴雨导致河水泛滥，淹没了大片农田和村庄。你的幸存者正处于水深火热之中，急需救援。',
        triggerConditions: {
            minPopulation: 30,
        },
        options: [
        ...
        options: [
            {
                ...
                text: '开发水源',
                description: '投入劳力开发，增加食物产出，幸存者增长加快。',
                effects: {
                    resourcePercent: {
                        wood: -0.022,
                        food: 0.03,
    ...
    },
    {
        ...
        icon: 'Users',
        image: null,
        description: '猎人们在部落区域边缘发现了不属于你们的陌生足迹，看起来是另一个部落的侦察队。',
        triggerConditions: {
            minEpoch: 0,
            maxEpoch: 0,
            minPopulation: 15,
        ...
        options: [
            {
                ...
                text: '分配稀缺物资',
                description: '严格分配食物和废材，确保每个人都能活下去。',
                effects: {
                    resourcePercent: {
                        food: -0.05,
                        wood: -0.06,
    ...
    },
    {
        ...
        options: [
            ...
            },
            {
                ...
                text: '鼓励口述传承',
                description: '将传说作为士气遗产，鼓励长老们讲述，但不进行实际探索。',
                effects: {
                    resourcePercent: {
                        culture: 0.06,
                    },
    ...
    },
    {
        ...
        icon: 'Gem',
        image: null,
        description: '探险队在偏远山区发现了一处富含电池和锡矿的矿脉，这是制造青铜的关键。这项发现可能彻底改变你的部落力量。',
        triggerConditions: {
            minEpoch: 1,
            maxEpoch: 1,
            minPopulation: 30,
        ...
        options: [
            {
                id: 'send_escort',
                text: '派遣军队护送',
                description: '消耗战斗力量，但获得贸易收益和外联声望。',
                effects: {
                    resourcePercent: {
                        silver: 0.012,
                        food: -0.015,
    ...
    },
    {
        ...
        icon: 'Droplets',
        image: null,
        description: '连年干旱，河流干涸，农作物大面积枯萎。部落的罐头储备迅速减少，饥荒的阴影笼罩着大地。',
        triggerConditions: {
            minEpoch: 1,
            maxEpoch: 1,
            minPopulation: 50,
        ...
        options: [
            ...
            },
            {
                id: 'seek_tribute',
                text: '向邻近部落施压',
                description: '派遣军队向邻近部落施压，要求他们提供罐头，但可能引发外联冲突。',
                effects: {
                    resourcePercent: {
                        food: 0.05,
                    },
        ...
        options: [
            {
                id: 'endorse_priest',
                text: '册封为国师',
                description: '利用其影响力巩固管理，提升士气和稳定。',
                effects: {
                    resourcePercent: {
                        culture: 0.08,
                    },
    ...
    },
    {
        ...
        icon: 'BookOpen',
        image: null,
        description: '一位极具魅力的哲学家在城邦广场上公开质疑神祇的权威和国家的传统。他的思想吸引了大量追随者，尤其是年轻的学者，但也激怒了祭司和保守派区长。',
        triggerConditions: {
            minEpoch: 2,
            maxEpoch: 2,
            minPopulation: 80,
        ...
        options: [
            {
                ...
                text: '拥抱理性思辨',
                description: '公开支持哲学家的学说，推动科学与士气发展，但会激怒宣传员。',
                effects: {
                    resourcePercent: {
                        science: 0.25,
                        culture: 0.15,
    ...
    },
    {
        ...
        icon: 'Gavel',
        image: null,
        description: '随着社会日益复杂，民众和商贩阶层要求制定一部清晰的成文法典，以取代区长们的任意判决。这对你的管理既是挑战也是机遇。',
        triggerConditions: {
            minEpoch: 2,
            maxEpoch: 2,
            minPopulation: 35,
        ...
        options: [
            {
                ...
                text: '颁布公正的法典',
                description: '组织抄写员和管理者编纂法典，明确所有阶层的权利与义务。',
                effects: {
                    resourcePercent: {
                        silver: -0.025,
                        papyrus: -50,
            ...
            },
            {
                id: 'favor_elite_code',
                text: '制定一部有利于精英的法律',
                description: '法典条文向区长和区长倾斜，以巩固他们的支持。',
                effects: {
                    resourcePercent: {
                        silver: -0.012,
                    },
        ...
        options: [
            {
                ...
                text: '慷慨解囊，举办盛大演出',
                description: '投入巨资打造一场空前绝后的演出，这将极大地提升士气声望。',
                effects: {
                    resourcePercent: {
                        silver: -0.03,
                        culture: 0.20,
    ...
    },
    {
        ...
        icon: 'Waves',
        image: null,
        description: '随着城市幸存者增长，供水问题日益严峻。一位建筑师向你提交了一份宏伟的引水渠设计图，声称可以从远方的山脉引来清泉，彻底解决城市的缺水问题。',
        triggerConditions: {
            minEpoch: 2,
            maxEpoch: 2,
            minPopulation: 40,
        ...
        options: [
            {
                id: 'grant_charter',
                text: '授予特许状',
                description: '承认行会的地位，这将提升工业产出和工匠的支持，但可能损害商贩的利益。',
                effects: {
                    resourcePercent: {
                        culture: 0.08,
                    },
            ...
            },
            {
                id: 'regulate_guilds',
                text: '加以管制',
                description: '允许行会存在，但必须接受管理者的严格监管，这让你能更好地控制市场。',
                effects: {
                    resourcePercent: {
                        silver: 0.02,
                    },
            ...
            },
            {
                id: 'suppress_guilds',
                text: '压制行会',
                description: '宣布行会为非法组织，以保护自由竞争和商贩的利益，但这会激怒工匠。',
                effects: {
                    stability: -8,
                    approval: {
                        artisan: -25,
    ...
    },
    {
        ...
        icon: 'Cross',
        image: null,
        description: '一位极具感召力的教士来到你的区域，号召信徒们加入一场针对遥远异教徒的“圣战”。你的骑士和宣传员对此热情高涨，但商贩们担心这会扰乱贸易。',
        triggerConditions: {
            minEpoch: 3,
            maxEpoch: 3,
            classConditions: {
        ...
        options: [
            ...
            },
            {
                id: 'denounce_call',
                text: '谴责此举',
                description: '宣布此举为鲁莽之举，会激怒信徒和战斗区长，但能赢得商贩的支持。',
                effects: {
                    stability: -10,
                    approval: {
                        cleric: -20,
    ...
    },
    {
        ...
        icon: 'ShieldAlert',
        image: null,
        description: '一位强大的封臣以区域歉收为由，拒绝履行提供骑士和士兵的封建义务。这直接挑战了你的权威。',
        triggerConditions: {
            minEpoch: 3,
            maxEpoch: 3,
            classConditions: {
        ...
        options: [
            ...
            },
            {
                id: 'accept_scutage',
                text: '准许以钱代役',
                description: '允许封臣支付一笔“盾牌钱”来免除兵役。这能充实物资库，但开了个坏头。',
                effects: {
                    resourcePercent: {
                        silver: 0.045,
                    },
    ...
    },
    {
        ...
        icon: 'Landmark',
        image: null,
        description: '一群来自各地的学者希望在你的都城建立一所“大学”，系统地教授神学、法律和医学。教会对此表示欢迎，但保守的区长认为这会动摇他们的地位。',
        triggerConditions: {
            minEpoch: 3,
            maxEpoch: 3,
            minPopulation: 50,
        ...
        options: [
            {
                ...
                text: '授予大学特许状',
                description: '为大学提供土地和资金，这将极大地推动科学和士气的发展。',
                effects: {
                    resourcePercent: {
                        silver: -0.012,
                        science: 0.30,
    ...
    },
    {
        ...
        icon: 'Heart',
        image: null,
        description: '一位身穿黑袍、头戴鸟嘴面具的“瘟疫医生”来到你的区域，声称有办法治疗肆虐的疾病。他的方法怪异，但似乎在某些地方取得了效果。',
        triggerConditions: {
            minEpoch: 3,
            maxEpoch: 4,
            minPopulation: 40,
        ...
        options: [
            {
                ...
                effects: {
                    ...
                    populationPercent: 0.03, // 象征性地恢复一些幸存者
                    stability: 5,
                    approval: {
                        peasant: 15,
                        cleric: -10, // 挑战教会的治疗权威
            ...
            },
            {
                ...
                text: '以“江湖骗子”之名驱逐',
                description: '认为他的方法是巫术和欺骗，将其赶出区域。',
                effects: {
                    populationPercent: -0.03,
                    stability: -8,
                    approval: {
    ...
    },
    {
        ...
        icon: 'Landmark',
        image: null,
        description: '一个富有的商贩家族开始涉足金融业，他们通过发行票据和提供贷款积累了巨大财富，并请求你授予他们“银行”的官方特许状。',
        triggerConditions: {
            minEpoch: 4,
            maxEpoch: 5,
            classConditions: {
        ...
        options: [
            ...
            },
            {
                ...
                text: '建立国家银行',
                description: '将银行业务收归国有，由管理者管理，以确保国家对金融的控制。',
                effects: {
                    resourcePercent: {
                        silver: -0.04, // 启动资金
                    },
    ...
    },
    {
        ...
        options: [
            ...
            },
            {
                ...
                text: '雇佣他们打一场仗',
                description: '支付一笔费用，让他们为你解决一个眼前的战斗麻烦。',
                effects: {
                    resourcePercent: {
                        silver: -0.012,
                    },
