 ...
 * - industry: 工业产出
 * - taxIncome: 税收收入
 * - scienceBonus, cultureBonus, militaryBonus: 研究/士气/战斗修正
 * - stability: 稳定度
 * - maxPop: 幸存者上限
...
export const POLITY_DEFINITIONS = [
    ...
    },
    {
        ...
        effects: {
            ...
            taxIncome: 0.12,
            cultureBonus: 0.08,
            officialCapacity: 5, // 官僚集权大幅增加管理者容量
        }
    },
    {
        name: '商业寡头政治',
        priority: 1000,
        description: '商贩阶层掌控国家',
        icon: 'Coins',
    ...
    },
    {
        ...
        effects: {
            ...
            officialCapacity: 4, // 技术官僚政治增加管理者容量
        }
    },
    {
        name: '学者治国',
    ...
    // 单一阶层兜底 (优先级 999)
    {
        ...
        effects: {
            stability: -0.05,
            taxIncome: 0.05,
            officialCapacity: 2, // 独裁政体少量增加管理者容量
        }
    },
    ...
    // 资产阶级民主
    {
        ...
        effects: {
            ...
            officialCapacity: 3, // 资产阶级共和国增加管理者容量
        }
    },
    {
        name: '资本主义寡头政治',
    ...
    // ============================================
    {
        ...
        effects: {
            ...
            stability: 0.12,
            officialCapacity: 4, // 全民联合政府增加管理者容量
        }
    },
    {
        name: '民族团结政府',
    ...
    },
    {
        ...
        effects: {
            ...
            officialCapacity: 3, // 技术精英政府增加管理者容量
        }
    },
...
export const formatPolityEffects = (effects) => {
    ...
    if (effects.maxPop !== undefined) {
        ...
        details.push({ text: `幸存者上限 ${sign}${effects.maxPop}`, positive: effects.maxPop >= 0 });
    }
    ...
    if (effects.resourceDemandMod) {
        Object.entries(effects.resourceDemandMod).forEach(([res, value]) => {
            const percent = (value * 100).toFixed(0);
            const sign = value >= 0 ? '+' : '';
            const resName = res === 'food' ? '食物' : res === 'wood' ? '废材' : res;
    ...
    if (effects.officialCapacity !== undefined) {
        ...
        details.push({ text: `管理者容量 ${sign}${effects.officialCapacity}`, positive: effects.officialCapacity >= 0 });
    }
