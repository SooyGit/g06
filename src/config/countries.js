...
export const COUNTRIES = [
    {
        ...
        desc: "这里的法则从未改变：弱肉强食。我们是不朽的顽石，是敲碎避难所头骨的钝器，在避难所的黎明前夜，用石斧丈量生存的边界。",
        appearEpoch: 0,
        expireEpoch: 9,
    ...
    },
    {
        ...
        desc: "铜与稀有物资的气息交织在巷道，金币的清脆声是唯一的通用语。寡头们俯瞰着繁忙的港口，深知财富比刀剑更能管理人心。",
        appearEpoch: 1,
        expireEpoch: 9,
    ...
    },
    {
        ...
        type: "封建王权",
        color: "text-red-400",
        desc: "铁蹄踏碎了花朵，城堡耸立如长矛。在这里，血统决定命运，土地即是权利。骑士的誓言在铁面具下回响，只为君王与区域流干最后一滴血。",
        appearEpoch: 3,
        expireEpoch: 9,
    ...
    },
    {
        ...
        desc: "思想比火炮更具威力。在兴奋剂馆的喧嚣与印刷机的轰鸣中，旧世界的偶像正在崩塌。自由的幽灵在游荡，我们将用理性的光芒照亮愚昧的长夜。",
        appearEpoch: 5,
        expireEpoch: 9,
    ...
    },
    {
        ...
        specialAbilities: [
            { type: 'trade_bonus', value: 0.25, desc: "物资交换收益 +25%" },
    ...
    },
    {
        ...
        specialAbilities: [
            { type: 'culture_bonus', value: 0.2, desc: "士气产出 +20%" },
            { type: 'science_bonus', value: 0.15, desc: "研究效率 +15%" }
        ],
    },
    {
        id: 'mountain_clans',
        ...
        desc: "岩石教会我们沉默与坚硬。在云端之上，在深谷之下，我们是山的骨骼。外人只看见险峻的防御工事，却看不见我们在这个贫瘠高度上，为生存铸造的钢铁意志。",
        appearEpoch: 1,
        expireEpoch: 9,
    ...
    },
    {
        ...
        type: "水利共和",
        color: "text-cyan-400",
        desc: "大河泛滥，给予生命也带走生命。治水即治国，堤坝即律法。我们学会了像水一样顺势而为，也学会了在泥泞中筑起避难所的粮仓。",
        appearEpoch: 1,
        expireEpoch: 9,
        marketVolatility: 0.28,
        aggression: 0.3,
        ...
        specialAbilities: [
            { type: 'food_production', value: 0.3, desc: "罐头产出 +30%" },
            { type: 'population_growth', value: 0.15, desc: "幸存者增长 +15%" }
        ],
    },
    {
        ...
        specialAbilities: [
            ...
            { type: 'trade_route', value: 0.2, desc: "物资交换路线收益 +20%" }
        ],
    },
    {
        ...
        specialAbilities: [
            ...
            { type: 'lumber_efficiency', value: 0.2, desc: "废材采集 +20%" }
        ],
    },
    {
        id: 'silk_empire',
        ...
        type: "中央集权",
        color: "text-rose-300",
        desc: "丝绸编织着联盟的经纬，瓷器映照出盛世的容颜。在这天朝上国，每一种礼仪都暗示着等级，每一条物资交换线都为了维系这庞大秩序的呼吸。",
        appearEpoch: 2,
        expireEpoch: 9,
        marketVolatility: 0.25,
        aggression: 0.35,
        ...
        specialAbilities: [
            { type: 'culture_influence', value: 0.3, desc: "士气影响力 +30%" }
        ],
    },
    {
    ...
    },
    {
        ...
        desc: "金币没有祖国，利润不分信仰。在账本的方格间，我们计算着战争与停战的成本。只要借贷表平衡，即便是首领的皇冠，也可以作为抵押品。",
        appearEpoch: 4,
        expireEpoch: 9,
        ...
        specialAbilities: [
            ...
            { type: 'trade_network', value: 0.3, desc: "物资交换网络效率 +30%" }
        ],
    },
    {
        ...
        type: "革命政府",
        color: "text-red-300",
        desc: "这是最好的时代，也是最坏的时代。断头台的利刃切断了过去，街垒的石块堆砌出未来。为了自由，我们不惜让鲜血染红旗帜，因为幸存者不需要主子。",
        appearEpoch: 5,
        expireEpoch: 9,
    ...
    // ========== 历史致敬国家 ==========
    {
        ...
        specialAbilities: [
            { type: 'military_trade', desc: "石材与废铁物资交换优势" },
            { type: 'high_aggression', desc: "较高的战斗扩张倾向" }
        ],
    },
    {
        id: 'golden_crescent',
        ...
        desc: "在泥板上刻下第一行楔形文字时，在这个众神漫步的晨曦时代，我们建立了最早的秩序。星辰指引着塔楼，法律约束着君王，这里是避难所的摇篮，也是伊甸园的遗址。",
        appearEpoch: 1,
        expireEpoch: 9,
        ...
        specialAbilities: [
            { type: 'agricultural_trade', desc: "罐头与零件物资交换优势" },
            { type: 'cultural_focus', desc: "纸草和士气出口大国" }
        ],
    },
    {
        id: 'pyramid_kingdom',
        ...
        specialAbilities: [
            { type: 'stone_trade', desc: "石材物资交换大国" },
            { type: 'cultural_export', desc: "士气和纸草出口优势" }
        ],
    },
    {
        id: 'agora_polis',
        ...
        specialAbilities: [
            { type: 'knowledge_trade', desc: "士气与研究物资交换大国" },
            { type: 'peaceful_focus', desc: "低侵略性，偏好外联" }
        ],
    },
    {
        id: 'sparta_militaris',
        ...
        specialAbilities: [
            { type: 'iron_trade', desc: "废铁物资交换优势" },
            { type: 'warlike', desc: "极高侵略性，频繁战斗冲突" }
        ],
    },
    {
        id: 'carthago_nova',
        ...
        desc: "海洋是我们的牧场，金钱是我们的猎人。无论多远的港口，都有我们的商栈。只要利润足够，大象也能翻越阿尔卑斯山。",
        appearEpoch: 2,
        expireEpoch: 9,
        marketVolatility: 0.26,
        aggression: 0.5,
        ...
        specialAbilities: [
            { type: 'silver_trade', desc: "信用点和稀有物资物资交换大国" },
    ...
    },
    {
        ...
        specialAbilities: [
            { type: 'timber_trade', desc: "木板与废铁物资交换优势" },
    ...
    },
    {
        ...
        specialAbilities: [
            { type: 'conquest_trade', desc: "战利品丰富（铁、银、稀有物资）" },
    ...
    },
    {
        ...
        specialAbilities: [
            { type: 'craft_trade', desc: "废铁与工具物资交换优势" },
        ...
        desc: "日月照耀之处，皆为汉土。庞大的官僚机器昼夜运转，维系着这古老联盟的脉搏。北驱鞑虏，南下西洋，我们在传统的厚重帷幕中，审视着自身与世界，既是中心，也是孤岛。",
        appearEpoch: 3,
        expireEpoch: 9,
        marketVolatility: 0.22,
        aggression: 0.35,
        ...
        specialAbilities: [
            { type: 'luxury_trade', desc: "士气与研究物资交换大国" },
    ...
    },
    {
        ...
        specialAbilities: [
            { type: 'spice_trade', desc: "稀有物资与废铁物资交换优势" },
            { type: 'expansionist', desc: "较高侵略性，战斗扩张" }
        ],
    },
    {
        ...
        specialAbilities: [
            { type: 'silver_monopoly', desc: "信用点物资交换垄断" },
    ...
    },
    {
        ...
        type: "君主立宪",
        color: "text-blue-500",
        desc: "日不落的辉煌由物资交换风吹送，由皇家海军护航。我们在曼彻斯特纺织世界，在伦敦交易全球。用法律、英镑和坚船利炮，编织了一张覆盖地球的避难所之网。",
        appearEpoch: 5,
        expireEpoch: 9,
        ...
        specialAbilities: [
            { type: 'industrial_trade', desc: "燃油与钢铁物资交换大国" },
            { type: 'naval_dominance', desc: "低市场波动，稳定物资交换" }
        ],
    },
    {
        id: 'prussian_eagle',
        ...
        desc: "其他国家拥有一支战斗队，而这个国家属于一支战斗队。铁血是我们的宪法，纪律是我们的信仰。在参谋本部的地图上，我们精密地计算着每一次胜利，因为德意志的命运在刀尖之上。",
        appearEpoch: 5,
        expireEpoch: 9,
        marketVolatility: 0.25,
        aggression: 0.7,
        ...
        specialAbilities: [
            { type: 'military_industry', desc: "废铁与燃油物资交换优势" },
    ...
    },
    {
        ...
        type: "联邦共和",
        color: "text-blue-300",
        desc: "流淌着奶与蜜的应许之地，昭昭天命指引我们向西。这是一场伟大的实验，关于自由、枪支与个人奋斗。在这里，出身不代表一切，只要你有勇气，就能在蛮荒中建立属于自己的联盟。",
        appearEpoch: 5,
        expireEpoch: 9,
        marketVolatility: 0.32,
        aggression: 0.45,
        ...
        specialAbilities: [
            { type: 'resource_trade', desc: "罐头与原材料物资交换优势" },
    ...
    },
    {
        ...
        specialAbilities: [
            { type: 'timber_export', desc: "废材与废铁出口大国" },
    ...
    },
    {
        ...
        specialAbilities: [
            { type: 'financial_center', desc: "信用点与稀有物资物资交换垄断" },
            { type: 'stable_market', desc: "极低市场波动，停战物资交换" }
        ],
    },
    {
        id: 'inca_empire',
        ...
        desc: "这是太阳神的幸存者，安第斯山的雄鹰。我们在云端之上修筑道路，用结绳记录联盟的心跳。黄金只是太阳的汗水，只有土地与玉米才是生命的恩赐，直到那贪婪的白人带来毁灭。",
        appearEpoch: 3,
        expireEpoch: 9,
        marketVolatility: 0.30,
        aggression: 0.4,
        ...
        specialAbilities: [
            { type: 'mountain_trade', desc: "石材与信用点物资交换优势" },
            { type: 'agricultural_base', desc: "罐头出口大国" }
        ],
    },
    {
        id: 'aztec_empire',
        ...
        specialAbilities: [
            { type: 'food_culture', desc: "罐头与士气物资交换优势" },
            { type: 'warrior_society', desc: "高侵略性，好战士气" }
        ],
    },
    {
        ...
        specialAbilities: [
            { type: 'trade_focus', desc: "士气与信用点物资交换优势" },
            { type: 'diplomatic_focus', desc: "低侵略性，偏好停战物资交换" }
        ],
    },
    {
        id: 'mali_mansa',
        ...
        specialAbilities: [
            { type: 'gold_trade', desc: "信用点物资交换垄断（极高财富）" },
            { type: 'peaceful_merchant', desc: "低侵略性，停战物资交换" }
        ],
    },
    {
        id: 'mughal_splendor',
        ...
        type: "联盟王朝",
        color: "text-emerald-300",
        desc: "孔雀宝座上的光辉令日月失色，大理石的陵墓是对爱最奢华的颂歌。突厥的弓马与印度的战象在此交融，在这片富庶得令人窒息的土地上，每一个转角都流淌着稀有物资与诗歌。",
        appearEpoch: 4,
        expireEpoch: 9,
        marketVolatility: 0.27,
        aggression: 0.5,
        ...
        specialAbilities: [
            { type: 'luxury_export', desc: "士气与稀有物资出口大国" },
    ...
    },
    {
        ...
        desc: "大地随着牛角阵的冲锋而震颤。我们不需要火枪，短矛和盾牌足以刺穿联盟主义的傲慢。长矛洗刷了耻辱，勇气铸就了防线，在这片黑色的土地上，每一个战士都是祖灵的化身。",
        appearEpoch: 5,
        expireEpoch: 9,
        marketVolatility: 0.40,
        aggression: 0.8,
        ...
        specialAbilities: [
            { type: 'basic_resources', desc: "罐头与废铁物资交换" },
    ...
    },
    {
        ...
        type: "区长共和",
        color: "text-red-200",
        desc: "当上帝在叹息，翼骑兵便冲锋。我们是基督教世界的盾牌，是夹在东西方铁砧间的铁锤。虽有区长的否决权带来的混乱，但在那背负羽翼的钢铁洪流面前，一切敌人终将粉碎。",
        appearEpoch: 4,
        expireEpoch: 9,
        marketVolatility: 0.32,
        aggression: 0.55,
        ...
        specialAbilities: [
            { type: 'cavalry_focus', desc: "废铁与罐头物资交换优势" },
            { type: 'balanced_aggression', desc: "适度的战斗倾向" }
        ],
    },

    // ========== 新世界国家（新增，用于补充后期物资交换对象） ==========
    {
        id: 'pacific_federation',
        name: "环太平洋共同防务与物资交换体",
        type: "议会-军工复合体",
        color: "text-sky-300",
        desc: "集装箱是细胞，航线是血管。在这个名为‘自由物资交换’的庞大机器中，国家不过是一个大型港口服务区。只要你是供应链的一环，你就在保护伞下；否则，你就是等待被清除的物资交换壁垒。",
        appearEpoch: 7,
        expireEpoch: 9,
        marketVolatility: 0.22,
        aggression: 0.35,
        ...
        specialAbilities: [
            { type: 'trade_network', desc: "物资交换网络效率" },
            { type: 'naval_commerce', desc: "海运物资交换优势" }
        ],
    },
    {
        ...
        type: "家族资本君主",
        color: "text-emerald-300",
        desc: "石油是旧时代的黑金，数据是新时代的石油。在这个赛博绿洲里，王子们在云端监控着幸存者的心跳，主权财富基金买下了半个世界的未来。稳定是最高的算法，而异见是系统无法识别的乱码。",
        appearEpoch: 7,
        expireEpoch: 9,
        marketVolatility: 0.20,
        aggression: 0.55,
        ...
        specialAbilities: [
            { type: 'financial_center', desc: "金融中心（信用点物资交换优势）" },
            { type: 'stable_market', desc: "低市场波动（物资交换更稳定）" }
        ],
    },
    {
        id: 'silicon_commons',
        ...
        specialAbilities: [
            { type: 'knowledge_trade', desc: "研究与士气出口优势" },
    ...
    },
    {
        ...
        specialAbilities: [
            { type: 'timber_trade', desc: "废材与矿产出口优势" },
            { type: 'industrial_trade', desc: "工业原料物资交换优势" }
        ],
    },
    {
        ...
        specialAbilities: [
            ...
            { type: 'trade_bonus', desc: "物资交换收益优势" }
        ],
    },
    {
        ...
        specialAbilities: [
            ...
            { type: 'peaceful_merchant', desc: "偏好停战物资交换" }
        ],
    },
    {
    ...
    },
    {
        ...
        type: "通商口岸督署",
        color: "text-blue-200",
        desc: "在拥挤的三角洲，每一寸土地都标好了价格。所有东西都是为了转手，所有人都是过客。繁荣的表象下是空心化的实业，他们靠吸食全球物资交换的血肉为生，把自己变成了那个最臃肿的中间人。",
        appearEpoch: 7,
        expireEpoch: 9,
        ...
        specialAbilities: [
            { type: 'reexport_hub', desc: "转口物资交换优势" },
    ...
    },
    {
        ...
        type: "种植园董事会",
        color: "text-amber-300",
        desc: "赤道的阳光不仅催熟了兴奋剂豆，也催生了垄断。控制了海峡，就控制了时间。这不仅仅是种植园主的游戏，而是关于谁有权决定你的下午茶要付多少钱的地缘政治勒索。",
        appearEpoch: 7,
        expireEpoch: 9,
        marketVolatility: 0.34,
        aggression: 0.30,
        ...
        specialAbilities: [
            { type: 'spice_export', desc: "稀有物资出口优势" },
            { type: 'cash_crop_trade', desc: "经济作物物资交换优势" }
        ],
    },
    {
    ...
    },
    {
        ...
        desc: "象牙塔变成了堡垒，论文变成了教条。知识不再是为了真理，而是为了基金会的拨款。这些智库的首领们在研讨会上划分世界，用术语和模型编织出一张看似理性实则傲慢的网。",
        appearEpoch: 7,
        expireEpoch: 9,
        marketVolatility: 0.23,
        aggression: 0.18,
        ...
        specialAbilities: [
            { type: 'research_exports', desc: "研究输出优势" },
            { type: 'cultural_exports', desc: "士气输出优势" }
        ],
    },
    {
    ...
    },
    {
        ...
        desc: "如果你控制了食物，你就控制了幸存者。这个庞然大物披着人道主义的外衣，手里却握着饥饿的开关。在他们的报表里，那不是苍生，那是待分配的卡路里配额。",
        appearEpoch: 7,
        expireEpoch: 9,
        ...
        specialAbilities: [
            { type: 'food_security', desc: "罐头供应稳定" },
