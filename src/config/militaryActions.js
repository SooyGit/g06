...
export const MILITARY_ACTIONS = [
    {
        ...
        deploymentRatio: { min: 0.05, max: 0.15 }, // 敌方派遣5%-15%战斗队
        enemyUnits: [],
    ...
    },
    {
        ...
        deploymentRatio: { min: 0.30, max: 0.70 }, // 敌方派遣30%-70%战斗队
        enemyUnits: [],
        cooldownDays: 24,  // [BUFFED] 8→24天，配合战利品×3
        requiresTech: 'bronze_working', // 需要青铜冶炼 - 正规战斗队需要金属武器
        // 正面攻势主要获取：战斗物资、金属、工业品
        // [BUFFED] 所有数值乘以3，配合冷却时间增加
        lootConfig: {
            // 基础资源
    ...
    },
    {
        ...
        deploymentRatio: { min: 0.35, max: 0.55 }, // 敌方派遣35%-55%战斗队
        enemyUnits: [],
        cooldownDays: 30,  // [BUFFED] 10→30天，配合战利品×3
        requiresTech: 'military_training', // 需要战斗训练 - 系统性破坏需要有组织的战斗队
