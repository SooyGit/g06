...
export const EPOCH_THEMES = {
  // 末日降临 - Stone Age (Enhanced Metal Texture)
  0: {
    name: '末日降临',
    primaryColor: '#d97706', // Amber
    secondaryColor: '#92400e',
    accentColor: '#fbbf24',
    bgGradient: 'linear-gradient(135deg, #1a0a0a 0%, #1a0a0a 50%, #1a0a0a 100%)',
    bgColor: '#1a0a0a',
  ...
  // 废墟拾荒 - Bronze Age (Enhanced Bronze Metal)
  1: {
    name: '废墟拾荒',
  ...
  // 堡垒建设 - Classical Age (Enhanced Blood & Marble)
  2: {
    name: '堡垒建设',
  ...
  // 病毒研究 - Age of Exploration (Enhanced Navy Blue & Blood)
  4: {
    name: '病毒研究',
  ...
  // 疫苗突破 - Age of Enlightenment (Enhanced Warm Blood & Brown)
  5: {
    name: '疫苗突破',
    primaryColor: '#880000', // 暗金黄 Dark Bloodenrod
  ...
  // 重建文明 - Industrial Age (Enhanced Iron & Steel Gray)
  6: {
    name: '重建文明',
