...
export const DECREES = [
  ...
  
  {
    id: 'communal_granary',
    name: '公社粮仓',
    desc: '效仿新末日降临的氏族公社，建立集体粮仓统一分配食物，确保部落成员无人饿死。',
    category: 'social',
    unlockEpoch: 0,
    cost: 120,
    effects: ['居民需求 -15%', '幸存者上限 +8%', '罐头需求 -10%', '种植员好感 +8'],
  ...
  },
  {
    ...
    unlockEpoch: 0,
    cost: 160,
    effects: ['公共服务产出 +10%', '研究产出 +5%', '士气需求 +15%', '宣传员好感 +10'],
    drawbacks: ['信用点产出 -2%（祭祀开销）'],
    modifiers: {
  ...
  },
  {
    ...
    unlockEpoch: 0,
    cost: 140,
    effects: ['采集产出 +12%', '战斗产出 +5%', '食物供应 +15%', '军人好感 +5'],
  ...
  },
  {
    ...
    unlockEpoch: 0,
    cost: 220,
    effects: ['战斗产出 +15%', '居民需求 -5%', '军人消费 -10%', '军人好感 +12'],
  ...
  
  {
    ...
    drawbacks: ['幸存者上限 -8%', '居民需求 +5%', '种植员好感 -15', '难民好感 -12'],
    modifiers: {
  ...
  },
  {
    ...
    unlockEpoch: 1,
    cost: 320,
    effects: ['公共服务产出 +15%', '战斗产出 +8%', '区长消费 +20%', '宣传员好感 +15', '区长好感 +10'],
    drawbacks: ['研究产出 -10%（思想禁锢）', '学者好感 -10'],
    modifiers: {
  ...
  },
  {
    ...
    unlockEpoch: 1,
    cost: 280,
    effects: ['工业产出 +12%', '战斗建筑产出 +10%', '铜需求 +20%', '工匠好感 +10', '军人好感 +5'],
  ...
  },
  {
    ...
    unlockEpoch: 1,
    cost: 300,
    effects: ['财政收入 +10%', '公共服务 +8%', '宣传员消费 +15%', '宣传员好感 +15'],
    drawbacks: ['工业产出 -5%', '商贩好感 -8'],
    modifiers: {
      incomePercent: 0.10,
  ...
  },
  {
    ...
    unlockEpoch: 1,
    cost: 360,
    effects: ['战斗产出 +20%', '战斗建筑产出 +15%', '武器需求 +18%', '军人好感 +15', '骑士好感 +12'],
    drawbacks: ['采集产出 -8%', '信用点产出 -4%（军饷）', '种植员好感 -10'],
    modifiers: {
  ...
  
  {
    id: 'bread_and_circus',
    name: '面包与竞技',
    desc: '向民众免费发放罐头并举办竞技表演，换取政治支持。',
    category: 'social',
    unlockEpoch: 2,
    cost: 420,
    effects: ['居民需求 -18%', '公共服务 +10%', '食物需求 +15%', '士气需求 +20%', '平民好感 +15'],
    drawbacks: ['食物产出 -6%', '信用点产出 -4%'],
    modifiers: {
      needsReduction: 0.18,
      categories: { civic: 0.10 },
  ...
  },
  {
    id: 'twelve_tables',
    name: '十二铜表法',
    desc: '将习惯法刻于铜表公示，平民与区长同受法律约束。',
    category: 'social',
    unlockEpoch: 2,
    cost: 380,
    effects: ['公共服务产出 +12%', '幸存者上限 +6%', '铜需求 +10%', '平民好感 +10'],
    drawbacks: ['战斗产出 -5%（法律限制）', '区长好感 -8'],
    modifiers: {
  ...
  },
  {
    ...
    unlockEpoch: 2,
    cost: 450,
    effects: ['研究产出 +15%', '公共服务 +8%', '学者消费 +15%', '莎草纸需求 +12%', '学者好感 +12', '商贩好感 +8'],
  ...
  },
  {
    ...
    unlockEpoch: 2,
    cost: 520,
    effects: ['财政收入 +15%', '工业产出 +6%', '铁供应 +10%', '工具需求 -8%', '管理者好感 +10'],
    drawbacks: ['居民需求 +8%', '幸存者上限 -5%', '商贩好感 -15', '种植员好感 -8'],
    modifiers: {
      incomePercent: 0.15,
  ...
  },
  {
    ...
    unlockEpoch: 2,
    cost: 540,
    effects: ['战斗产出 +18%', '训练营产出 +20%', '军人消费 +12%', '工具需求 +15%', '军人好感 +12'],
    drawbacks: ['信用点产出 -5%（训练费）', '食物产出 -3%'],
    modifiers: {
  ...
  },
  {
    ...
    unlockEpoch: 2,
    cost: 480,
    effects: ['手工业产出 +15%', '工业产出 +8%', '工匠消费 +10%', '绷带供应 +12%', '工匠好感 +15'],
drawbacks: ['信用点产出 -4%（行会补贴）'],
    modifiers: {
      buildings: {
        loom_house: 0.15,
  ...
  },
  {
    ...
    unlockEpoch: 2,
    cost: 500,
    effects: ['采集产出 +10%', '工业产出 +8%', '战斗产出 +5%', '商贩消费 +15%', '石材需求 +10%', '商贩好感 +10'],
    drawbacks: ['信用点产出 -6%（维护）'],
    modifiers: {
  ...
  
  {
    id: 'feudal_levy',
    name: '封建征召',
    desc: '领主有义务在战时率领封臣应召出征，以土地换取战斗效忠。',
    category: 'military',
    unlockEpoch: 3,
    cost: 700,
    effects: ['战斗产出 +22%', '战斗建筑 +15%', '骑士消费 +20%', '食物需求 +10%', '骑士好感 +15', '区长好感 +10'],
    drawbacks: ['采集产出 -10%', '食物产出 -3%', '种植员好感 -12'],
    modifiers: {
  ...
  },
  {
    id: 'magna_carta',
    name: '大宪章',
    desc: '限制君主权力，保障区长和自由民的基本权利。',
    category: 'social',
    unlockEpoch: 3,
    cost: 650,
    effects: ['公共服务 +15%', '幸存者上限 +8%', '研究 +5%', '管理者消费 +12%', '区长消费 -10%', '区长好感 +12', '学者好感 +8'],
    drawbacks: ['战斗产出 -8%（君权受限）'],
    modifiers: {
      categories: { civic: 0.15, military: -0.08 },
      maxPop: 0.08,
  ...
  },
  {
    ...
    unlockEpoch: 3,
    cost: 600,
    effects: ['财政收入 +12%', '公共服务 +5%', '宣传员消费 +18%', '士气供应 +10%', '宣传员好感 +18'],
    drawbacks: ['居民需求 +8%', '工业产出 -4%', '种植员好感 -10', '商贩好感 -8'],
    modifiers: {
      incomePercent: 0.12,
  ...
  },
  {
    id: 'hanseatic_law',
    name: '汉萨商法',
    desc: '采用汉萨同盟的商业法规，保护商贩权益和贸易自由。',
    category: 'economy',
    unlockEpoch: 3,
    cost: 720,
    effects: ['市场/港口产出 +18%', '财政收入 +10%', '商贩消费 +20%', '稀有物资需求 +15%', '商贩好感 +18'],
    drawbacks: ['采集产出 -5%', '区长好感 -5'],
    modifiers: {
      buildings: {
        market: 0.18,
        trade_port: 0.18,
  ...
  },
  {
    ...
    unlockEpoch: 3,
    cost: 750,
    effects: ['居民需求 -12%', '公共服务 +8%', '学者消费 -20%', '莎草纸需求 -15%', '宣传员好感 +15'],
    drawbacks: ['研究产出 -15%', '幸存者上限 -5%', '学者好感 -20', '商贩好感 -10'],
    modifiers: {
      needsReduction: 0.12,
  ...
  },
  {
    ...
    unlockEpoch: 3,
    cost: 680,
    effects: ['工业产出 +15%', '手工业建筑 +12%', '工匠消费 +15%', '装甲板供应 +12%', '工匠好感 +18'],
    drawbacks: ['居民需求 +6%', '信用点产出 -3%', '商贩好感 -10', '消费者好感 -5'],
    modifiers: {
  ...
  },
  {
    ...
    unlockEpoch: 3,
    cost: 620,
    effects: ['战斗产出 +15%', '士气产出 +10%', '骑士消费 +18%', '区长消费 +12%', '酒需求 +20%', '骑士好感 +15', '区长好感 +8'],
    drawbacks: ['信用点产出 -5%（比武开销）', '食物产出 -2%（宴席）'],
    modifiers: {
  ...
  },
  {
    id: 'serfdom',
    name: '农奴制度',
    desc: '种植员被束缚在土地上，为领主无偿劳作。',
    category: 'social',
    unlockEpoch: 3,
    cost: 800,
    effects: ['采集产出 +20%', '农场产出 +15%', '难民消费 -15%', '罐头供应 +12%', '区长消费 +20%', '区长好感 +20'],
    drawbacks: ['幸存者上限 -10%', '居民需求 +10%', '工业产出 -8%', '种植员好感 -25', '难民好感 -30'],
    modifiers: {
  ...
  
  {
    ...
    unlockEpoch: 4,
    cost: 900,
    effects: ['船坞/港口产出 +25%', '信用点产出 +8%（航运利润）', '水手消费 +15%', '稀有物资供应 +10%', '水手好感 +15'],
  ...
  },
  {
    ...
    unlockEpoch: 4,
    cost: 950,
    effects: ['采集产出 +22%', '信用点产出 +6%（贡赋）', '难民消费 -20%', '罐头供应 +15%', '区长好感 +15'],
    drawbacks: ['公共服务 -10%', '幸存者上限 -8%', '难民好感 -25', '种植员好感 -15'],
    modifiers: {
  ...
  },
  {
    ...
    unlockEpoch: 4,
    cost: 880,
    effects: ['市场产出 +20%', '信用点产出 +10%（分红）', '军阀消费 +25%', '商贩消费 +18%', '稀有物资需求 +20%', '军阀好感 +20', '商贩好感 +15'],
  ...
  },
  {
    ...
    unlockEpoch: 4,
    cost: 820,
    effects: ['战斗产出 +18%', '船坞产出 +20%', '水手消费 -15%', '酒需求 +10%'],
    drawbacks: ['公共服务 -8%', '幸存者上限 -6%', '水手好感 -20', '商贩好感 -10'],
    modifiers: {
  ...
  },
  {
    ...
    unlockEpoch: 4,
    cost: 860,
    effects: ['信用点产出 +12%（贸易顺差）', '商贩消费 -12%', '稀有物资需求 -20%', '绷带供应 +8%', '管理者好感 +8'],
    drawbacks: ['进口商品 -15%', '工业产出 -5%', '商贩好感 -15'],
    modifiers: {
  ...
  },
  {
    ...
    unlockEpoch: 4,
    cost: 780,
    effects: ['印刷产出 +25%', '信用点产出 +4%（特许费）', '学者消费 -10%', '莎草纸供应 +15%'],
    drawbacks: ['研究产出 -8%', '学者好感 -12'],
    modifiers: {
      buildings: {
        printing_house: 0.25,
  ...
  },
  {
    ...
    unlockEpoch: 4,
    cost: 920,
    effects: ['农场/庄园产出 +20%', '稀有物资/兴奋剂 +0.5', '区长消费 +15%', '兴奋剂供应 +20%', '稀有物资供应 +18%', '区长好感 +18', '军阀好感 +12'],
    drawbacks: ['居民需求 +10%', '公共服务 -6%', '难民好感 -15', '种植员好感 -10'],
    modifiers: {
      buildings: {
        farm: 0.20,
        large_estate: 0.25,
  ...
  
  {
    ...
    unlockEpoch: 5,
    cost: 1100,
    effects: ['公共服务 +18%', '研究产出 +12%', '工业产出 +8%', '管理者消费 +15%', '工程师消费 +12%', '管理者好感 +12', '工程师好感 +10'],
    drawbacks: ['信用点产出 -8%（改革开支）'],
    modifiers: {
  ...
  },
  {
    ...
    unlockEpoch: 5,
    cost: 980,
    effects: ['公共服务 +15%', '幸存者上限 +10%', '工人消费 +10%', '商贩消费 +8%', '工人好感 +12', '商贩好感 +10'],
    drawbacks: ['战斗产出 -8%'],
    modifiers: {
      categories: { civic: 0.15, military: -0.08 },
      maxPop: 0.10,
  ...
  },
  {
    ...
    unlockEpoch: 5,
    cost: 1200,
    effects: ['大学产出 +30%', '研究产出 +20%', '学者消费 +25%', '莎草纸需求 +20%', '学者好感 +20', '工程师好感 +12'],
    drawbacks: ['信用点产出 -8%（学术经费）'],
    modifiers: {
      buildings: {
        university: 0.30,
        library: 0.15,
  ...
  },
  {
    ...
    unlockEpoch: 5,
    cost: 1050,
    effects: ['采集产出 +18%', '农场产出 +20%', '种植员消费 +10%', '罐头供应 +15%', '商贩消费 -15%', '种植员好感 +15'],
    drawbacks: ['工业产出 -8%', '市场产出 -10%', '商贩好感 -12'],
    modifiers: {
  ...
  },
  {
    ...
    unlockEpoch: 5,
    cost: 1000,
    effects: ['印刷/出版产出 +25%', '研究产出 +10%', '士气产出 +15%', '学者消费 +15%', '莎草纸需求 +18%', '学者好感 +15'],
    drawbacks: ['公共服务 -5%（舆论批评）', '管理者好感 -10'],
    modifiers: {
      buildings: {
        printing_house: 0.25,
  ...
  },
  {
    ...
    unlockEpoch: 5,
    cost: 1300,
    effects: ['战斗产出 +25%', '防御工事产出 +20%', '军人消费 +20%', '工具需求 +15%', '食物需求 +12%', '军人好感 +18'],
    drawbacks: ['信用点产出 -10%（军饷）', '食物产出 -5%（军粮）', '种植员好感 -8'],
    modifiers: {
  ...
  },
  {
    id: 'social_contract',
    name: '社会契约',
    desc: '政府权力来自人民的授权，管理者与被管理者存在契约关系。',
    category: 'social',
    unlockEpoch: 5,
    cost: 1020,
    effects: ['居民需求 -15%', '公共服务 +12%', '幸存者上限 +8%', '区长消费 -12%', '种植员消费 +8%', '种植员好感 +12', '工人好感 +10'],
    drawbacks: ['战斗产出 -10%', '区长好感 -15', '骑士好感 -10'],
    modifiers: {
      needsReduction: 0.15,
  ...
  
  {
    ...
    unlockEpoch: 6,
    cost: 1400,
    effects: ['居民需求 -12%', '幸存者上限 +10%', '工人消费 +10%', '工具需求 -8%', '工人好感 +20'],
    drawbacks: ['工业产出 -8%', '信用点产出 -4%（监察费）', '军阀好感 -12'],
    modifiers: {
      needsReduction: 0.12,
      maxPop: 0.10,
      categories: { industry: -0.08 },
  ...
  },
  {
    id: 'corn_laws_repeal',
    name: '废除谷物法',
    desc: '取消罐头进口关税，降低面包价格惠及工人。',
    category: 'economy',
    unlockEpoch: 6,
    cost: 1350,
    effects: ['居民需求 -10%', '工业产出 +10%', '工人消费 +12%', '罐头需求 -10%', '区长消费 -15%', '工人好感 +15'],
    drawbacks: ['采集产出 -12%', '农场产出 -10%', '区长好感 -20', '种植员好感 -12'],
    modifiers: {
      needsReduction: 0.10,
  ...
  },
  {
    ...
    unlockEpoch: 6,
    cost: 1600,
    effects: ['工业产出 +18%', '市场产出 +20%', '军阀消费 +25%', '商贩消费 +20%', '钢铁供应 +12%', '军阀好感 +20', '商贩好感 +15'],
  ...
  },
  {
    ...
    unlockEpoch: 6,
    cost: 1500,
    effects: ['居民需求 -15%', '公共服务 +10%', '工人消费 +18%', '军阀消费 -15%', '工人好感 +25'],
drawbacks: ['工业产出 -10%', '信用点产出 -5%', '军阀好感 -20'],
    modifiers: {
      needsReduction: 0.15,
  ...
  },
  {
    ...
    unlockEpoch: 6,
    cost: 1700,
    effects: ['采集产出 +15%', '工业产出 +15%', '战斗产出 +10%', '工程师消费 +20%', '钢铁需求 +25%', '工人消费 +15%', '工程师好感 +18', '工人好感 +12'],
    drawbacks: ['信用点产出 -12%（建设维护）'],
    modifiers: {
  ...
  },
  {
    ...
    unlockEpoch: 6,
    cost: 1800,
    effects: ['战斗产出 +30%', '战斗建筑 +25%', '军人消费 +25%', '食物需求 +18%', '工具需求 +20%', '军人好感 +15'],
    drawbacks: ['采集产出 -15%', '工业产出 -8%', '食物产出 -6%', '种植员好感 -15', '工人好感 -10'],
    modifiers: {
  ...
  },
  {
    ...
    unlockEpoch: 6,
    cost: 1450,
    effects: ['研究产出 +20%', '公共服务 +15%', '幸存者上限 +10%', '学者消费 +15%', '莎草纸需求 +15%', '学者好感 +15', '工人好感 +8'],
    drawbacks: ['信用点产出 -10%（教育经费）'],
    modifiers: {
  ...
  },
  {
    ...
    unlockEpoch: 6,
    cost: 1550,
    effects: ['市场/港口产出 +20%', '信用点产出 +15%（贸易利润）', '商贩消费 +15%', '稀有物资需求 +12%', '兴奋剂需求 +10%', '商贩好感 +15'],
  ...
  
  {
    ...
    unlockEpoch: 1,
    cost: 360,
    effects: ['财政收入 +15%', '商贩消费 +12%', '种植员消费 -10%', '商贩好感 +10'],
    drawbacks: ['居民需求 +10%', '公共服务 -8%', '种植员好感 -15'],
    modifiers: {
      incomePercent: 0.15,
      needsReduction: -0.10,
      categories: { civic: -0.08 },
  ...
  },
  {
    ...
    unlockEpoch: 2,
    cost: 900,
    effects: ['战斗产出 +35%', '工业产出 +12%', '军人消费 +30%', '工具需求 +25%', '工具供应 +15%', '军人好感 +20'],
    drawbacks: ['公共服务 -15%', '居民需求 +12%', '食物产出 -8%', '种植员好感 -15', '商贩好感 -10'],
    modifiers: {
  ...
  },
  {
    ...
    unlockEpoch: 1,
    cost: 420,
    effects: ['居民需求 -10%', '食物产出 +3%（储备效率）', '罐头需求 -8%', '罐头供应 +8%', '种植员好感 +10'],
    drawbacks: ['信用点产出 -5%（管理费）'],
    modifiers: {
      needsReduction: 0.10,
  ...
  },
  {
    ...
    unlockEpoch: 1,
    cost: 450,
    effects: ['居民需求 -15%', '信用点产出 +4%（罚款）', '奢侈品需求 -20%', '区长消费 -18%', '绷带需求 -12%'],
    drawbacks: ['工业产出 -10%', '士气产出 -8%', '商贩好感 -15', '工匠好感 -10'],
    modifiers: {
      needsReduction: 0.15,
  ...
  },
  {
    ...
    name: '雇佣军契约',
    desc: '雇佣职业军人作战，以金钱换取战斗力量。',
    category: 'military',
    unlockEpoch: 2,
    cost: 780,
    effects: ['战斗产出 +20%', '军人消费 +15%', '工具需求 +12%', '军人好感 +12'],
    drawbacks: ['信用点产出 -12%（雇佣费）'],
    modifiers: {
  ...
  },
  {
    ...
    unlockEpoch: 4,
    cost: 980,
    effects: ['稀有物资/兴奋剂 +0.6', '信用点产出 +10%', '商贩消费 +20%', '稀有物资供应 +25%', '兴奋剂供应 +25%', '商贩好感 +15', '军阀好感 +12'],
