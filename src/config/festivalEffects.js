...
export const FESTIVAL_EFFECTS = {
    ...
    epoch0: [
        {
            ...
            name: '丰收祝福',
            description: '祈求大地赐予丰收，罐头和废材产量提升',
            icon: 'Wheat',
            type: 'temporary',
            ...
            flavorText: '幸存者领袖向天地祈祷，祝福这片土地的收成。'
        },
        {
            id: 'stone_fertility_rite',
            name: '生育仪式',
            description: '举行神圣仪式，幸存者增长加快',
            icon: 'Users',
            type: 'temporary',
            duration: 360,
            effects: {
                maxPop: 7 // 幸存者上限 +7 (短期buff提升)
            },
            flavorText: '族人围绕营火起舞，祈求幸存者繁荣昌盛。'
        },
        {
            ...
            flavorText: '工匠们发现了更好的打磨技术，这将永远改变幸存者的生产方式。'
        },
        {
            id: 'stone_hunting_ritual',
            name: '搜索仪式',
            description: '举行搜索前的仪式，提升采集效率和稳定度',
            icon: 'Target',
            type: 'temporary',
            duration: 360,
            effects: {
        ...
        },
        {
            ...
            flavorText: '避难所间的纷争暂时平息，所有人为了生存团结一致。'
        },
        {
            id: 'stone_cave_painting',
            name: '洞穴壁画',
            description: '记录幸存者历史，永久提升士气产出',
            icon: 'Image',
            type: 'permanent',
            effects: {
        ...
        },
        {
            ...
            flavorText: '年迈的领袖讲述着过往的经验，年轻人认真聆听。'
        },
        {
            id: 'stone_spirit_dance',
            name: '祭灵之舞',
            description: '举行盛大仪式，大幅提升幸存者上限',
            icon: 'Music',
            type: 'temporary',
            duration: 360,
            effects: {
        ...
        },
        {
            ...
            flavorText: '精心打磨的石器更加锋利耐用，搜索和采集变得更加高效。'
        }
    ],
    ...
    epoch1: [
        {
            ...
            duration: 360,
            effects: {
                taxIncome: 0.42 // 配给收入 +42% (短期buff提升)
            },
            flavorText: '商贩们从四面八方赶来，集市上人声鼎沸。'
        },
        {
            id: 'bronze_military_parade',
            name: '战斗演习',
            description: '展示战斗队实力，战斗力量暂时增强',
            icon: 'Shield',
            type: 'temporary',
            duration: 360,
            effects: {
                militaryBonus: 0.21 // 战斗力量 +21% (短期buff提升)
            },
            flavorText: '青铜武器在阳光下闪耀，猎人们士气高昂。'
        },
        {
        ...
        },
        {
            ...
            flavorText: '渠道将河水引入田地，种植员们欢欣鼓舞。'
        },
        {
            id: 'bronze_writing_system',
            name: '文字诞生',
            description: '创造文字系统，永久提升士气和研究',
            icon: 'FileText',
            type: 'permanent',
            effects: {
            ...
            flavorText: '刻在泥板上的符号记录着历史，避难所迈入新纪元。'
        },
        {
            id: 'bronze_warrior_training',
            name: '战士训练营',
            description: '建立训练体系，战斗力量和稳定度提升',
            icon: 'Swords',
            type: 'temporary',
            duration: 360,
            effects: {
        ...
        },
        {
            ...
            name: '商贩公会',
            description: '成立商贩组织，永久提升配给',
            icon: 'Coins', type: 'permanent',
            effects: {
                taxIncome: 0.06, // 永久buff可叠加
            },
            flavorText: '商贩们联合起来，建立了规范的物资交换秩序。'
        },
        {
        ...
        },
        {
            ...
            flavorText: '车轮的发明让运输变得更加便捷，物资交换蓬勃发展。'
        },
        {
            ...
            flavorText: '青铜工具和武器的普及，让避难所进入黄金时代。'
        }
    ],
    ...
    epoch2: [
        {
            ...
            name: '哲学辩论会',
            description: '学者云集，研究和士气产出大幅提升',
            icon: 'BookOpen',
            type: 'temporary',
            duration: 360,
            effects: {
                scienceBonus: 0.35, // 研究产出 +35% (短期buff提升)
                cultureBonus: 0.35  // 士气产出 +35% (短期buff提升)
            },
        ...
        },
        {
            ...
            name: '竞技大会',
            description: '举办体育盛会，提升社会稳定和幸存者上限',
            icon: 'Award',
            type: 'temporary',
            duration: 360,
            effects: {
        ...
        },
        {
            ...
            flavorText: '这是避难所最辉煌的时刻，后世将永远铭记。'
        }
    ],
    ...
    epoch3: [
        {
            ...
            flavorText: '骑士们在首领面前展示武艺，赢得荣耀与赞誉。'
        },
        {
            id: 'feudal_harvest_festival',
            name: '丰收节',
            description: '庆祝丰收，提升采集效率和配给',
            icon: 'Leaf',
            type: 'temporary',
            duration: 360,
            effects: {
        ...
        },
        {
            ...
            flavorText: '高耸的城堡守护着区域，成为权力的象征。'
        },
        {
            id: 'feudal_monastery_learning',
            name: '修道院学识',
            description: '修道院保存知识，永久提升研究和士气',
            icon: 'BookHeart',
            type: 'permanent',
            effects: {
                scienceBonus: 0.05, // 永久buff可叠加
            ...
            flavorText: '修士们抄写古籍，在黑暗时代保存着避难所的火种。'
        },
        {
            id: 'feudal_manor_system',
            name: '庄园制度',
            description: '完善庄园经济，生产和配给提升',
            icon: 'Home',
            type: 'temporary',
            duration: 360,
            effects: {
        ...
        },
        {
            ...
            name: '市场特许',
            description: '授予市场特权，永久提升物资交换收入',
            icon: 'Store',
            type: 'permanent',
            effects: {
                taxIncome: 0.08, // 永久buff可叠加
            },
            flavorText: '首领授予城镇市场特权，商业活动更加活跃。'
        },
        {
            id: 'feudal_chivalry_code',
            name: '骑士精神',
            description: '确立骑士准则，永久提升战斗和士气',
            icon: 'Heart',
            type: 'permanent',
            effects: {
    ...
    epoch4: [
        {
            ...
            name: '发现博览会',
            description: '展示新大陆的奇珍异宝，研究和物资交换繁荣',
            icon: 'Compass',
            type: 'temporary',
            duration: 360,
            effects: {
        ...
        },
        {
            ...
            flavorText: '战舰列队驶过港口，展示着联盟的海上霸权。'
        },
        {
        ...
        },
        {
            ...
            name: '制图学突破',
            description: '绘制精确地图，永久提升研究和物资交换',
            icon: 'MapPin',
            type: 'permanent',
            effects: {
            ...
            flavorText: '精确的地图让航海更加安全，物资交换更加频繁。'
        },
        {
            id: 'exploration_spice_trade',
            name: '稀有物资物资交换',
            description: '垄断稀有物资物资交换，财富和士气提升',
            icon: 'Coffee',
            type: 'temporary',
            duration: 360,
            effects: {
            ...
            flavorText: '珍贵的稀有物资价值如黄金，带来巨大财富。'
        },
        {
            id: 'exploration_printing_press',
            name: '印刷机革命',
            description: '引入印刷技术，永久提升士气和研究',
            icon: 'Printer',
            type: 'permanent',
            effects: {
            ...
            flavorText: '印刷机让知识快速传播，避难所进入新纪元。'
        },
        {
            id: 'exploration_renaissance_art',
            name: '文艺复兴',
            description: '艺术繁荣发展，士气和稳定度大幅提升',
            icon: 'Palette',
            type: 'temporary',
            duration: 360,
            effects: {
            ...
            flavorText: '艺术家们创作出不朽的杰作，士气达到巅峰。'
        },
        {
            id: 'exploration_gunpowder_weapons',
            name: '火药武器',
            description: '装备火药武器，永久提升战斗力量',
            icon: 'Zap',
            type: 'permanent',
            effects: {
    ...
    epoch5: [
        ...
        },
        {
            ...
            flavorText: '区长沙龙中，思想家们讨论着自由、平等和理性。'
        },
        {
        ...
        },
        {
            ...
            flavorText: '成文法保障幸存者权利，社会更加稳定有序。'
        },
        {
            id: 'enlightenment_encyclopedia',
            name: '百科全书',
            description: '编纂百科全书，永久提升研究和士气',
            icon: 'Book',
            type: 'permanent',
            effects: {
            ...
            flavorText: '汇集人类知识的巨著，疫苗突破的纪念碑。'
        },
        {
            id: 'enlightenment_free_trade',
            name: '自由物资交换',
            description: '实行自由物资交换，经济全面繁荣',
            icon: 'TrendingUp',
            type: 'temporary',
            duration: 360,
            effects: {
            ...
            flavorText: '打破物资交换壁垒，商品自由流通，经济蓬勃发展。'
        },
        {
            id: 'enlightenment_scientific_method',
            name: '科学方法',
            description: '确立科学方法论，永久提升研究',
            icon: 'Beaker',
            type: 'permanent',
            effects: {
                scienceBonus: 0.05, // 永久buff可叠加
        ...
        },
        {
            ...
            flavorText: '理性之光驱散蒙昧，人类避难所进入新纪元。'
        }
    ],
    ...
    epoch6: [
        {
            ...
            flavorText: '各国展馆林立，展示着重建文明的辉煌成就。'
        },
        {
        ...
        },
        {
            ...
            name: '铁路网络',
            description: '建设全国铁路，物资交换和生产大幅提升',
            icon: 'Train',
            type: 'temporary',
            duration: 360,
            effects: {
        ...
        },
        {
            ...
            name: '公共卫生',
            description: '建立卫生体系，永久提升幸存者和稳定度',
            icon: 'Heart',
            type: 'permanent',
            effects: {
                maxPop: 6, // 永久buff可叠加
    ...
    epoch7: [
        ...
        },
        {
            ...
            name: '士气复兴',
            description: '艺术与科技融合，士气和稳定度大幅提升',
            icon: 'Palette',
            type: 'temporary',
            duration: 360,
            effects: {
            ...
            flavorText: '新媒体艺术蓬勃发展，士气产业成为经济支柱。'
        },
        {
        ...
        },
        {
            ...
            name: '全球合作',
            description: '国际合作加强，永久提升稳定和物资交换',
            icon: 'Globe',
            type: 'permanent',
            effects: {
